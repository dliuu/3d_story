...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function _h(){return new Ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ac(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function gh(){return new Ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ac(),fragmentShader:`
...
`)}function cx(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ar).join(`
`)}function lx(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function hx(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function Ar(s){return s!==""}function Ah(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wh(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ux=/^[ \t]*#include +<([\w\d./]+)>/gm;function tc(s){return s.replace(ux,fx)}const dx=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function fx(s,e){let t=Ie[e];if(t===void 0){const n=dx.get(e);if(n!==void 0)t=Ie[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return tc(t)}const px=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Rh(s){return s.replace(px,mx)}function mx(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ch(s){let e=`precision ${s.precision} float;
...
`].filter(Ar).join(`
`)),a=tc(a),a=Ah(a,t),a=wh(a,t),o=tc(o),o=Ah(o,t),o=wh(o,t),a=Rh(a),o=Rh(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
`,m=[g,"precision mediump sampler2DArray;","#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+m,y=["precision mediump sampler2DArray;","#define varying in",t.glslVersion===Xl?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===Xl?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+y);const M=x+m+a,E=x+y+o,A=Eh(i,i.VERTEX_SHADER,M),T=Eh(i,i.FRAGMENT_SHADER,E);i.attachShader(p,A),i.attachShader(p,T),t.index0AttributeName!==void 0?i.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(p,0,"position"),i.linkProgram(p);function R(B){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(p).trim(),P=i.getShaderInfoLog(A).trim(),F=i.getShaderInfoLog(T).trim();let N=!0,Y=!0;if(i.getProgramParameter(p,i.LINK_STATUS)===!1)if(N=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,p,A,T);else{const X=bh(i,A,"vertex"),j=bh(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(p,i.VALIDATE_STATUS)+`
...
*/var ln={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Yr={duration:.5,overwrite:!1,delay:0},Bc,Ut,at,vn=1e8,Je=1/vn,oc=Math.PI*2,wM=oc/4,RM=0,gd=Math.sqrt,CM=Math.cos,PM=Math.sin,Pt=function(e){return typeof e=="string"},dt=function(e){return typeof e=="function"},ei=function(e){return typeof e=="number"},kc=function(e){return typeof e>"u"},Fn=function(e){return typeof e=="object"},$t=function(e){return e!==!1},zc=function(){return typeof window<"u"},pa=function(e){return dt(e)||Pt(e)},xd=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},zt=Array.isArray,LM=/random\([^)]+\)/g,DM=/,\s*/g,su=/(?:-?\.?\d|\.)+/gi,vd=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,wr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Fo=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Md=/[+-]=-?[.\d]+/,IM=/[^,'"\[\]\s]+/gi,NM=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ht,Cn,cc,Gc,hn={},Pa={},yd,Sd=function(e){return(Pa=jr(e,hn))&&en},Hc=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},ws=function(e,t){return!t&&console.warn(e)},Td=function(e,t){return e&&(hn[e]=t)&&Pa&&(Pa[e]=t)||hn},Rs=function(){return 0},UM={suppressEvents:!0,isStart:!0,kill:!1},va={suppressEvents:!0,kill:!1},OM={suppressEvents:!0},Vc={},Ei=[],lc={},Ed,sn={},Bo={},au=30,Ma=[],Wc="",Xc=function(e){var t=e[0],n,i;if(Fn(t)||dt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=Ma.length;i--&&!Ma[i].targetTest(t););n=Ma[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new jd(e[i],n)))||e.splice(i,1);return e},Qi=function(e){return e._gsap||Xc(Mn(e))[0]._gsap},bd=function(e,t,n){return(n=e[t])&&dt(n)?e[t]():kc(n)&&e.getAttribute&&e.getAttribute(t)||n},Zt=function(e,t){return(e=e.split(",")).forEach(t)||e},_t=function(e){return Math.round(e*1e5)/1e5||0},lt=function(e){return Math.round(e*1e7)/1e7||0},Nr=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},FM=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},La=function(){var e=Ei.length,t=Ei.slice(0),n,i;for(lc={},Ei.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},qc=function(e){return!!(e._initted||e._startAt||e.add)},Ad=function(e,t,n,i){Ei.length&&!Ut&&La(),e.render(t,n,!!(Ut&&t<0&&qc(e))),Ei.length&&!Ut&&La()},wd=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(IM).length<2?t:Pt(e)?e.trim():e},Rd=function(e){return e},un=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},BM=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},jr=function(e,t){for(var n in t)e[n]=t[n];return e},ou=function s(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Fn(t[n])?s(e[n]||(e[n]={}),t[n]):t[n]);return e},Da=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},ys=function(e){var t=e.parent||ht,n=e.keyframes?BM(zt(e.keyframes)):un;if($t(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},kM=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},Cd=function(e,t,n,i,r){var a=e[i],o;if(r)for(o=t[r];a&&a[r]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=a,t.parent=t._dp=e,t},Va=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var r=t._prev,a=t._next;r?r._next=a:e[n]===t&&(e[n]=a),a?a._prev=r:e[i]===t&&(e[i]=r),t._next=t._prev=t.parent=null},wi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},er=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},zM=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},hc=function(e,t,n,i){return e._startAt&&(Ut?e._startAt.revert(va):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},GM=function s(e){return!e||e._ts&&s(e.parent)},cu=function(e){return e._repeat?Kr(e._tTime,e=e.duration()+e._rDelay)*e:0},Kr=function(e,t){var n=Math.floor(e=lt(e/t));return e&&n===e?n-1:n},Ia=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Wa=function(e){return e._end=lt(e._start+(e._tDur/Math.abs(e._ts||e._rts||Je)||0))},Xa=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=lt(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Wa(e),n._dirty||er(n,e)),e},Pd=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Ia(e.rawTime(),t),(!t._dur||Os(0,t.totalDuration(),n)-t._tTime>Je)&&t.render(n,!0)),er(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-Je}},Dn=function(e,t,n,i){return t.parent&&wi(t),t._start=lt((ei(n)?n:n||e!==ht?mn(e,n,t):e._time)+t._delay),t._end=lt(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Cd(e,t,"_first","_last",e._sort?"_start":0),uc(t)||(e._recent=t),i||Pd(e,t),e._ts<0&&Xa(e,e._tTime),e},Ld=function(e,t){return(hn.ScrollTrigger||Hc("scrollTrigger",t))&&hn.ScrollTrigger.create(t,e)},Dd=function(e,t,n,i,r){if(jc(e,t,r),!e._initted)return 1;if(!n&&e._pt&&!Ut&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Ed!==an.frame)return Ei.push(e),e._lazy=[r,i],1},HM=function s(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||s(t))},uc=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},VM=function(e,t,n,i){var r=e.ratio,a=t<0||!t&&(!e._start&&HM(e)&&!(!e._initted&&uc(e))||(e._ts<0||e._dp._ts<0)&&!uc(e))?0:1,o=e._rDelay,c=0,l,h,u;if(o&&e._repeat&&(c=Os(0,e._tDur,t),h=Kr(c,o),e._yoyo&&h&1&&(a=1-a),h!==Kr(e._tTime,o)&&(r=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==r||Ut||i||e._zTime===Je||!t&&e._zTime){if(!e._initted&&Dd(e,t,i,n,c))return;for(u=e._zTime,e._zTime=t||(n?Je:0),n||(n=t&&!u),e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=c,l=e._pt;l;)l.r(a,l.d),l=l._next;t<0&&hc(e,t,n,!0),e._onUpdate&&!n&&on(e,"onUpdate"),c&&e._repeat&&!n&&e.parent&&on(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&wi(e,1),!n&&!Ut&&(on(e,a?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},WM=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},$r=function(e,t,n,i){var r=e._repeat,a=lt(t)||0,o=e._tTime/e._tDur;return o&&!i&&(e._time*=a/e._dur),e._dur=a,e._tDur=r?r<0?1e10:lt(a*(r+1)+e._rDelay*r):a,o>0&&!i&&Xa(e,e._tTime=e._tDur*o),e.parent&&Wa(e),n||er(e.parent,e),e},lu=function(e){return e instanceof Wt?er(e):$r(e,e._dur)},XM={_start:0,endTime:Rs,totalDuration:Rs},mn=function s(e,t,n){var i=e.labels,r=e._recent||XM,a=e.duration()>=vn?r.endTime(!1):e._dur,o,c,l;return Pt(t)&&(isNaN(t)||t in i)?(c=t.charAt(0),l=t.substr(-1)==="%",o=t.indexOf("="),c==="<"||c===">"?(o>=0&&(t=t.replace(/=/,"")),(c==="<"?r._start:r.endTime(r._repeat>=0))+(parseFloat(t.substr(1))||0)*(l?(o<0?r:n).totalDuration()/100:1)):o<0?(t in i||(i[t]=a),i[t]):(c=parseFloat(t.charAt(o-1)+t.substr(o+1)),l&&n&&(c=c/100*(zt(n)?n[0]:n).totalDuration()),o>1?s(e,t.substr(0,o-1),n)+c:a+c)):t==null?a:+t},Ss=function(e,t,n){var i=ei(t[1]),r=(i?2:1)+(e<2?0:1),a=t[r],o,c;if(i&&(a.duration=t[1]),a.parent=n,e){for(o=a,c=n;c&&!("immediateRender"in o);)o=c.vars.defaults||{},c=$t(c.vars.inherit)&&c.parent;a.immediateRender=$t(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[r-1]}return new vt(t[0],a,t[r+1])},Li=function(e,t){return e||e===0?t(e):t},Os=function(e,t,n){return n<e?e:n>t?t:n},kt=function(e,t){return!Pt(e)||!(t=NM.exec(e))?"":t[1]},qM=function(e,t,n){return Li(n,function(i){return Os(e,t,i)})},dc=[].slice,Id=function(e,t){return e&&Fn(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Fn(e[0]))&&!e.nodeType&&e!==Cn},YM=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var r;return Pt(i)&&!t||Id(i,1)?(r=n).push.apply(r,Mn(i)):n.push(i)})||n},Mn=function(e,t,n){return at&&!t&&at.selector?at.selector(e):Pt(e)&&!n&&(cc||!Zr())?dc.call((t||Gc).querySelectorAll(e),0):zt(e)?YM(e,n):Id(e)?dc.call(e,0):e?[e]:[]},fc=function(e){return e=Mn(e)[0]||ws("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return Mn(t,n.querySelectorAll?n:n===e?ws("Invalid scope")||Gc.createElement("div"):e)}},Nd=function(e){return e.sort(function(){return .5-Math.random()})},Ud=function(e){if(dt(e))return e;var t=Fn(e)?e:{each:e},n=tr(t.ease),i=t.from||0,r=parseFloat(t.base)||0,a={},o=i>0&&i<1,c=isNaN(i)||o,l=t.axis,h=i,u=i;return Pt(i)?h=u={center:.5,edges:.5,end:1}[i]||0:!o&&c&&(h=i[0],u=i[1]),function(d,f,g){var _=(g||t).length,p=a[_],m,y,x,M,E,A,T,R,L;if(!p){if(L=t.grid==="auto"?0:(t.grid||[1,vn])[1],!L){for(T=-vn;T<(T=g[L++].getBoundingClientRect().left)&&L<_;);L<_&&L--}for(p=a[_]=[],m=c?Math.min(L,_)*h-.5:i%L,y=L===vn?0:c?_*u/L-.5:i/L|0,T=0,R=vn,A=0;A<_;A++)x=A%L-m,M=y-(A/L|0),p[A]=E=l?Math.abs(l==="y"?M:x):gd(x*x+M*M),E>T&&(T=E),E<R&&(R=E);i==="random"&&Nd(p),p.max=T-R,p.min=R,p.v=_=(parseFloat(t.amount)||parseFloat(t.each)*(L>_?_-1:l?l==="y"?_/L:L:Math.max(L,_/L))||0)*(i==="edges"?-1:1),p.b=_<0?r-_:r,p.u=kt(t.amount||t.each)||0,n=n&&_<0?Xd(n):n}return _=(p[d]-p.min)/p.max||0,lt(p.b+(n?n(_):_)*p.v)+p.u}},pc=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=lt(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(ei(n)?0:kt(n))}},Od=function(e,t){var n=zt(e),i,r;return!n&&Fn(e)&&(i=n=e.radius||vn,e.values?(e=Mn(e.values),(r=!ei(e[0]))&&(i*=i)):e=pc(e.increment)),Li(t,n?dt(e)?function(a){return r=e(a),Math.abs(r-a)<=i?r:a}:function(a){for(var o=parseFloat(r?a.x:a),c=parseFloat(r?a.y:0),l=vn,h=0,u=e.length,d,f;u--;)r?(d=e[u].x-o,f=e[u].y-c,d=d*d+f*f):d=Math.abs(e[u]-o),d<l&&(l=d,h=u);return h=!i||l<=i?e[h]:a,r||h===a||ei(a)?h:h+kt(a)}:pc(e))},Fd=function(e,t,n,i){return Li(zt(e)?!t:n===!0?!!(n=0):!i,function(){return zt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},jM=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(r,a){return a(r)},i)}},KM=function(e,t){return function(n){return e(parseFloat(n))+(t||kt(n))}},$M=function(e,t,n){return kd(e,t,0,1,n)},Bd=function(e,t,n){return Li(n,function(i){return e[~~t(i)]})},ZM=function s(e,t,n){var i=t-e;return zt(e)?Bd(e,s(0,e.length),t):Li(n,function(r){return(i+(r-e)%i)%i+e})},JM=function s(e,t,n){var i=t-e,r=i*2;return zt(e)?Bd(e,s(0,e.length-1),t):Li(n,function(a){return a=(r+(a-e)%r)%r||0,e+(a>i?r-a:a)})},Cs=function(e){return e.replace(LM,function(t){var n=t.indexOf("[")+1,i=t.substring(n||7,n?t.indexOf("]"):t.length-1).split(DM);return Fd(n?i:+i[0],n?0:+i[1],+i[2]||1e-5)})},kd=function(e,t,n,i,r){var a=t-e,o=i-n;return Li(r,function(c){return n+((c-e)/a*o||0)})},QM=function s(e,t,n,i){var r=isNaN(e+t)?0:function(f){return(1-f)*e+f*t};if(!r){var a=Pt(e),o={},c,l,h,u,d;if(n===!0&&(i=1)&&(n=null),a)e={p:e},t={p:t};else if(zt(e)&&!zt(t)){for(h=[],u=e.length,d=u-2,l=1;l<u;l++)h.push(s(e[l-1],e[l]));u--,r=function(g){g*=u;var _=Math.min(d,~~g);return h[_](g-_)},n=t}else i||(e=jr(zt(e)?[]:{},e));if(!h){for(c in t)Yc.call(o,e,c,"get",t[c]);r=function(g){return Zc(g,o)||(a?e.p:e)}}}return Li(n,r)},hu=function(e,t,n){var i=e.labels,r=vn,a,o,c;for(a in i)o=i[a]-t,o<0==!!n&&o&&r>(o=Math.abs(o))&&(c=a,r=o);return c},on=function(e,t,n){var i=e.vars,r=i[t],a=at,o=e._ctx,c,l,h;if(r)return c=i[t+"Params"],l=i.callbackScope||e,n&&Ei.length&&La(),o&&(at=o),h=c?r.apply(l,c):r.call(l),at=a,h},ms=function(e){return wi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Ut),e.progress()<1&&on(e,"onInterrupt"),e},Rr,zd=[],Gd=function(e){if(e)if(e=!e.name&&e.default||e,zc()||e.headless){var t=e.name,n=dt(e),i=t&&!n&&e.init?function(){this._props=[]}:e,r={init:Rs,render:Zc,add:Yc,kill:my,modifier:py,rawVars:0},a={targetTest:0,get:0,getSetter:$c,aliases:{},register:0};if(Zr(),e!==i){if(sn[t])return;un(i,un(Da(e,r),a)),jr(i.prototype,jr(r,Da(e,a))),sn[i.prop=t]=i,e.targetTest&&(Ma.push(i),Vc[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Td(t,i),e.register&&e.register(en,i,Jt)}else zd.push(e)},Ze=255,_s={aqua:[0,Ze,Ze],lime:[0,Ze,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Ze],navy:[0,0,128],white:[Ze,Ze,Ze],olive:[128,128,0],yellow:[Ze,Ze,0],orange:[Ze,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Ze,0,0],pink:[Ze,192,203],cyan:[0,Ze,Ze],transparent:[Ze,Ze,Ze,0]},ko=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Ze+.5|0},Hd=function(e,t,n){var i=e?ei(e)?[e>>16,e>>8&Ze,e&Ze]:0:_s.black,r,a,o,c,l,h,u,d,f,g;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),_s[e])i=_s[e];else if(e.charAt(0)==="#"){if(e.length<6&&(r=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e="#"+r+r+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&Ze,i&Ze,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&Ze,e&Ze]}else if(e.substr(0,3)==="hsl"){if(i=g=e.match(su),!t)c=+i[0]%360/360,l=+i[1]/100,h=+i[2]/100,a=h<=.5?h*(l+1):h+l-h*l,r=h*2-a,i.length>3&&(i[3]*=1),i[0]=ko(c+1/3,r,a),i[1]=ko(c,r,a),i[2]=ko(c-1/3,r,a);else if(~e.indexOf("="))return i=e.match(vd),n&&i.length<4&&(i[3]=1),i}else i=e.match(su)||_s.transparent;i=i.map(Number)}return t&&!g&&(r=i[0]/Ze,a=i[1]/Ze,o=i[2]/Ze,u=Math.max(r,a,o),d=Math.min(r,a,o),h=(u+d)/2,u===d?c=l=0:(f=u-d,l=h>.5?f/(2-u-d):f/(u+d),c=u===r?(a-o)/f+(a<o?6:0):u===a?(o-r)/f+2:(r-a)/f+4,c*=60),i[0]=~~(c+.5),i[1]=~~(l*100+.5),i[2]=~~(h*100+.5)),n&&i.length<4&&(i[3]=1),i},Vd=function(e){var t=[],n=[],i=-1;return e.split(bi).forEach(function(r){var a=r.match(wr)||[];t.push.apply(t,a),n.push(i+=a.length+1)}),t.c=n,t},uu=function(e,t,n){var i="",r=(e+i).match(bi),a=t?"hsla(":"rgba(",o=0,c,l,h,u;if(!r)return e;if(r=r.map(function(d){return(d=Hd(d,t,1))&&a+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(h=Vd(e),c=n.c,c.join(i)!==h.c.join(i)))for(l=e.replace(bi,"1").split(wr),u=l.length-1;o<u;o++)i+=l[o]+(~c.indexOf(o)?r.shift()||a+"0,0,0,0)":(h.length?h:r.length?r:n).shift());if(!l)for(l=e.split(bi),u=l.length-1;o<u;o++)i+=l[o]+r[o];return i+l[u]},bi=function(){var s="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in _s)s+="|"+e+"\\b";return new RegExp(s+")","gi")}(),ey=/hsl[a]?\(/,Wd=function(e){var t=e.join(" "),n;if(bi.lastIndex=0,bi.test(t))return n=ey.test(t),e[1]=uu(e[1],n),e[0]=uu(e[0],n,Vd(e[1])),!0},Ps,an=function(){var s=Date.now,e=500,t=33,n=s(),i=n,r=1e3/240,a=r,o=[],c,l,h,u,d,f,g=function _(p){var m=s()-i,y=p===!0,x,M,E,A;if((m>e||m<0)&&(n+=m-t),i+=m,E=i-n,x=E-a,(x>0||y)&&(A=++u.frame,d=E-u.time*1e3,u.time=E=E/1e3,a+=x+(x>=r?4:r-x),M=1),y||(c=l(_)),M)for(f=0;f<o.length;f++)o[f](E,d,A,p)};return u={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(p){return d/(1e3/(p||60))},wake:function(){yd&&(!cc&&zc()&&(Cn=cc=window,Gc=Cn.document||{},hn.gsap=en,(Cn.gsapVersions||(Cn.gsapVersions=[])).push(en.version),Sd(Pa||Cn.GreenSockGlobals||!Cn.gsap&&Cn||{}),zd.forEach(Gd)),h=typeof requestAnimationFrame<"u"&&requestAnimationFrame,c&&u.sleep(),l=h||function(p){return setTimeout(p,a-u.time*1e3+1|0)},Ps=1,g(2))},sleep:function(){(h?cancelAnimationFrame:clearTimeout)(c),Ps=0,l=Rs},lagSmoothing:function(p,m){e=p||1/0,t=Math.min(m||33,e)},fps:function(p){r=1e3/(p||240),a=u.time*1e3+r},add:function(p,m,y){var x=m?function(M,E,A,T){p(M,E,A,T),u.remove(x)}:p;return u.remove(p),o[y?"unshift":"push"](x),Zr(),x},remove:function(p,m){~(m=o.indexOf(p))&&o.splice(m,1)&&f>=m&&f--},_listeners:o},u}(),Zr=function(){return!Ps&&an.wake()},We={},ty=/^[\d.\-M][\d.\-,\s]/,ny=/["']/g,iy=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],r=1,a=n.length,o,c,l;r<a;r++)c=n[r],o=r!==a-1?c.lastIndexOf(","):c.length,l=c.substr(0,o),t[i]=isNaN(l)?l.replace(ny,"").trim():+l,i=c.substr(o+1).trim();return t},ry=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},sy=function(e){var t=(e+"").split("("),n=We[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[iy(t[1])]:ry(e).split(",").map(wd)):We._CE&&ty.test(e)?We._CE("",e):n},Xd=function(e){return function(t){return 1-e(1-t)}},qd=function s(e,t){for(var n=e._first,i;n;)n instanceof Wt?s(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?s(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},tr=function(e,t){return e&&(dt(e)?e:We[e]||sy(e))||t},sr=function(e,t,n,i){n===void 0&&(n=function(c){return 1-t(1-c)}),i===void 0&&(i=function(c){return c<.5?t(c*2)/2:1-t((1-c)*2)/2});var r={easeIn:t,easeOut:n,easeInOut:i},a;return Zt(e,function(o){We[o]=hn[o]=r,We[a=o.toLowerCase()]=n;for(var c in r)We[a+(c==="easeIn"?".in":c==="easeOut"?".out":".inOut")]=We[o+"."+c]=r[c]}),r},Yd=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},zo=function s(e,t,n){var i=t>=1?t:1,r=(n||(e?.3:.45))/(t<1?t:1),a=r/oc*(Math.asin(1/i)||0),o=function(h){return h===1?1:i*Math.pow(2,-10*h)*PM((h-a)*r)+1},c=e==="out"?o:e==="in"?function(l){return 1-o(1-l)}:Yd(o);return r=oc/r,c.config=function(l,h){return s(e,l,h)},c},Go=function s(e,t){t===void 0&&(t=1.70158);var n=function(a){return a?--a*a*((t+1)*a+t)+1:0},i=e==="out"?n:e==="in"?function(r){return 1-n(1-r)}:Yd(n);return i.config=function(r){return s(e,r)},i};Zt("Linear,Quad,Cubic,Quart,Quint,Strong",function(s,e){var t=e<5?e+1:e;sr(s+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});We.Linear.easeNone=We.none=We.Linear.easeIn;sr("Elastic",zo("in"),zo("out"),zo());(function(s,e){var t=1/e,n=2*t,i=2.5*t,r=function(o){return o<t?s*o*o:o<n?s*Math.pow(o-1.5/e,2)+.75:o<i?s*(o-=2.25/e)*o+.9375:s*Math.pow(o-2.625/e,2)+.984375};sr("Bounce",function(a){return 1-r(1-a)},r)})(7.5625,2.75);sr("Expo",function(s){return Math.pow(2,10*(s-1))*s+s*s*s*s*s*s*(1-s)});sr("Circ",function(s){return-(gd(1-s*s)-1)});sr("Sine",function(s){return s===1?1:-CM(s*wM)+1});sr("Back",Go("in"),Go("out"),Go());We.SteppedEase=We.steps=hn.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),r=t?1:0,a=1-Je;return function(o){return((i*Os(0,a,o)|0)+r)*n}}};Yr.ease=We["quad.out"];Zt("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(s){return Wc+=s+","+s+"Params,"});var jd=function(e,t){this.id=RM++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:bd,this.set=t?t.getSetter:$c},Ls=function(){function s(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,$r(this,+t.duration,1,1),this.data=t.data,at&&(this._ctx=at,at.data.push(this)),Ps||an.wake()}var e=s.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,$r(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(Zr(),!arguments.length)return this._tTime;var r=this._dp;if(r&&r.smoothChildTiming&&this._ts){for(Xa(this,n),!r._dp||r.parent||Pd(r,this);r&&r.parent;)r.parent._time!==r._start+(r._ts>=0?r._tTime/r._ts:(r.totalDuration()-r._tTime)/-r._ts)&&r.totalTime(r._tTime,!0),r=r.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Dn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Je||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Ad(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+cu(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+cu(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*r,i):this._repeat?Kr(this._tTime,r)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-Je?0:this._rts;if(this._rts===n)return this;var r=this.parent&&this._ts?Ia(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Je?0:this._rts,this.totalTime(Os(-Math.abs(this._delay),this.totalDuration(),r),i!==!1),Wa(this),zM(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Zr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Je&&(this._tTime-=Je)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=lt(n);var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Dn(i,this,this._start-this._delay),this}return this._start},e.endTime=function(n){return this._start+($t(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Ia(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=OM);var i=Ut;return Ut=n,qc(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Ut=i,this},e.globalTime=function(n){for(var i=this,r=arguments.length?n:i.rawTime();i;)r=i._start+r/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):r},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,lu(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,lu(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(mn(this,n),$t(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,$t(i)),this._dur||(this._zTime=-Je),this},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Je:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-Je,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,r;return!!(!n||this._ts&&this._initted&&n.isActive()&&(r=n.rawTime(!0))>=i&&r<this.endTime(!0)-Je)},e.eventCallback=function(n,i,r){var a=this.vars;return arguments.length>1?(i?(a[n]=i,r&&(a[n+"Params"]=r),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},e.then=function(n){var i=this,r=i._prom;return new Promise(function(a){var o=dt(n)?n:Rd,c=function(){var h=i.then;i.then=null,r&&r(),dt(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=h),a(o),i.then=h};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?c():i._prom=c})},e.kill=function(){ms(this)},s}();un(Ls.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Je,_prom:0,_ps:!1,_rts:1});var Wt=function(s){_d(e,s);function e(n,i){var r;return n===void 0&&(n={}),r=s.call(this,n)||this,r.labels={},r.smoothChildTiming=!!n.smoothChildTiming,r.autoRemoveChildren=!!n.autoRemoveChildren,r._sort=$t(n.sortChildren),ht&&Dn(n.parent||ht,jn(r),i),n.reversed&&r.reverse(),n.paused&&r.paused(!0),n.scrollTrigger&&Ld(jn(r),n.scrollTrigger),r}var t=e.prototype;return t.to=function(i,r,a){return Ss(0,arguments,this),this},t.from=function(i,r,a){return Ss(1,arguments,this),this},t.fromTo=function(i,r,a,o){return Ss(2,arguments,this),this},t.set=function(i,r,a){return r.duration=0,r.parent=this,ys(r).repeatDelay||(r.repeat=0),r.immediateRender=!!r.immediateRender,new vt(i,r,mn(this,a),1),this},t.call=function(i,r,a){return Dn(this,vt.delayedCall(0,i,r),a)},t.staggerTo=function(i,r,a,o,c,l,h){return a.duration=r,a.stagger=a.stagger||o,a.onComplete=l,a.onCompleteParams=h,a.parent=this,new vt(i,a,mn(this,c)),this},t.staggerFrom=function(i,r,a,o,c,l,h){return a.runBackwards=1,ys(a).immediateRender=$t(a.immediateRender),this.staggerTo(i,r,a,o,c,l,h)},t.staggerFromTo=function(i,r,a,o,c,l,h,u){return o.startAt=a,ys(o).immediateRender=$t(o.immediateRender),this.staggerTo(i,r,o,c,l,h,u)},t.render=function(i,r,a){var o=this._time,c=this._dirty?this.totalDuration():this._tDur,l=this._dur,h=i<=0?0:lt(i),u=this._zTime<0!=i<0&&(this._initted||!l),d,f,g,_,p,m,y,x,M,E,A,T;if(this!==ht&&h>c&&i>=0&&(h=c),h!==this._tTime||a||u){if(o!==this._time&&l&&(h+=this._time-o,i+=this._time-o),d=h,M=this._start,x=this._ts,m=!x,u&&(l||(o=this._zTime),(i||!r)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,p=l+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(p*100+i,r,a);if(d=lt(h%p),h===c?(_=this._repeat,d=l):(E=lt(h/p),_=~~E,_&&_===E&&(d=l,_--),d>l&&(d=l)),E=Kr(this._tTime,p),!o&&this._tTime&&E!==_&&this._tTime-E*p-this._dur<=0&&(E=_),A&&_&1&&(d=l-d,T=1),_!==E&&!this._lock){var R=A&&E&1,L=R===(A&&_&1);if(_<E&&(R=!R),o=R?0:h%l?l:h,this._lock=1,this.render(o||(T?0:lt(_*p)),r,!l)._lock=0,this._tTime=h,!r&&this.parent&&on(this,"onRepeat"),this.vars.repeatRefresh&&!T&&(this.invalidate()._lock=1,E=_),o&&o!==this._time||m!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(l=this._dur,c=this._tDur,L&&(this._lock=2,o=R?l:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!T&&this.invalidate()),this._lock=0,!this._ts&&!m)return this;qd(this,T)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(y=WM(this,lt(o),lt(d)),y&&(h-=d-(d=y._start))),this._tTime=h,this._time=d,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&h&&l&&!r&&!E&&(on(this,"onStart"),this._tTime!==h))return this;if(d>=o&&i>=0)for(f=this._first;f;){if(g=f._next,(f._act||d>=f._start)&&f._ts&&y!==f){if(f.parent!==this)return this.render(i,r,a);if(f.render(f._ts>0?(d-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(d-f._start)*f._ts,r,a),d!==this._time||!this._ts&&!m){y=0,g&&(h+=this._zTime=-Je);break}}f=g}else{f=this._last;for(var v=i<0?i:d;f;){if(g=f._prev,(f._act||v<=f._end)&&f._ts&&y!==f){if(f.parent!==this)return this.render(i,r,a);if(f.render(f._ts>0?(v-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(v-f._start)*f._ts,r,a||Ut&&qc(f)),d!==this._time||!this._ts&&!m){y=0,g&&(h+=this._zTime=v?-Je:Je);break}}f=g}}if(y&&!r&&(this.pause(),y.render(d>=o?0:-Je)._zTime=d>=o?1:-1,this._ts))return this._start=M,Wa(this),this.render(i,r,a);this._onUpdate&&!r&&on(this,"onUpdate",!0),(h===c&&this._tTime>=this.totalDuration()||!h&&o)&&(M===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!l)&&(h===c&&this._ts>0||!h&&this._ts<0)&&wi(this,1),!r&&!(i<0&&!o)&&(h||o||!c)&&(on(this,h===c&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(h<c&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,r){var a=this;if(ei(r)||(r=mn(this,r,i)),!(i instanceof Ls)){if(zt(i))return i.forEach(function(o){return a.add(o,r)}),this;if(Pt(i))return this.addLabel(i,r);if(dt(i))i=vt.delayedCall(0,i);else return this}return this!==i?Dn(this,i,r):this},t.getChildren=function(i,r,a,o){i===void 0&&(i=!0),r===void 0&&(r=!0),a===void 0&&(a=!0),o===void 0&&(o=-vn);for(var c=[],l=this._first;l;)l._start>=o&&(l instanceof vt?r&&c.push(l):(a&&c.push(l),i&&c.push.apply(c,l.getChildren(!0,r,a)))),l=l._next;return c},t.getById=function(i){for(var r=this.getChildren(1,1,1),a=r.length;a--;)if(r[a].vars.id===i)return r[a]},t.remove=function(i){return Pt(i)?this.removeLabel(i):dt(i)?this.killTweensOf(i):(i.parent===this&&Va(this,i),i===this._recent&&(this._recent=this._last),er(this))},t.totalTime=function(i,r){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=lt(an.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),s.prototype.totalTime.call(this,i,r),this._forcing=0,this):this._tTime},t.addLabel=function(i,r){return this.labels[i]=mn(this,r),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,r,a){var o=vt.delayedCall(0,r||Rs,a);return o.data="isPause",this._hasPause=1,Dn(this,o,mn(this,i))},t.removePause=function(i){var r=this._first;for(i=mn(this,i);r;)r._start===i&&r.data==="isPause"&&wi(r),r=r._next},t.killTweensOf=function(i,r,a){for(var o=this.getTweensOf(i,a),c=o.length;c--;)gi!==o[c]&&o[c].kill(i,r);return this},t.getTweensOf=function(i,r){for(var a=[],o=Mn(i),c=this._first,l=ei(r),h;c;)c instanceof vt?FM(c._targets,o)&&(l?(!gi||c._initted&&c._ts)&&c.globalTime(0)<=r&&c.globalTime(c.totalDuration())>r:!r||c.isActive())&&a.push(c):(h=c.getTweensOf(o,r)).length&&a.push.apply(a,h),c=c._next;return a},t.tweenTo=function(i,r){r=r||{};var a=this,o=mn(a,i),c=r,l=c.startAt,h=c.onStart,u=c.onStartParams,d=c.immediateRender,f,g=vt.to(a,un({ease:r.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:r.duration||Math.abs((o-(l&&"time"in l?l.time:a._time))/a.timeScale())||Je,onStart:function(){if(a.pause(),!f){var p=r.duration||Math.abs((o-(l&&"time"in l?l.time:a._time))/a.timeScale());g._dur!==p&&$r(g,p,0,1).render(g._time,!0,!0),f=1}h&&h.apply(g,u||[])}},r));return d?g.render(0):g},t.tweenFromTo=function(i,r,a){return this.tweenTo(r,un({startAt:{time:mn(this,i)}},a))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),hu(this,mn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),hu(this,mn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Je)},t.shiftChildren=function(i,r,a){a===void 0&&(a=0);var o=this._first,c=this.labels,l;for(i=lt(i);o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(r)for(l in c)c[l]>=a&&(c[l]+=i);return er(this)},t.invalidate=function(i){var r=this._first;for(this._lock=0;r;)r.invalidate(i),r=r._next;return s.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var r=this._first,a;r;)a=r._next,this.remove(r),r=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),er(this)},t.totalDuration=function(i){var r=0,a=this,o=a._last,c=vn,l,h,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)l=o._prev,o._dirty&&o.totalDuration(),h=o._start,h>c&&a._sort&&o._ts&&!a._lock?(a._lock=1,Dn(a,o,h-o._delay,1)._lock=0):c=h,h<0&&o._ts&&(r-=h,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=lt(h/a._ts),a._time-=h,a._tTime-=h),a.shiftChildren(-h,!1,-1/0),c=0),o._end>r&&o._ts&&(r=o._end),o=l;$r(a,a===ht&&a._time>r?a._time:r,1,1),a._dirty=0}return a._tDur},e.updateRoot=function(i){if(ht._ts&&(Ad(ht,Ia(i,ht)),Ed=an.frame),an.frame>=au){au+=ln.autoSleep||120;var r=ht._first;if((!r||!r._ts)&&ln.autoSleep&&an._listeners.length<2){for(;r&&!r._ts;)r=r._next;r||an.sleep()}}},e}(Ls);un(Wt.prototype,{_lock:0,_hasPause:0,_forcing:0});var ay=function(e,t,n,i,r,a,o){var c=new Jt(this._pt,e,t,0,1,ef,null,r),l=0,h=0,u,d,f,g,_,p,m,y;for(c.b=n,c.e=i,n+="",i+="",(m=~i.indexOf("random("))&&(i=Cs(i)),a&&(y=[n,i],a(y,e,t),n=y[0],i=y[1]),d=n.match(Fo)||[];u=Fo.exec(i);)g=u[0],_=i.substring(l,u.index),f?f=(f+1)%5:_.substr(-5)==="rgba("&&(f=1),g!==d[h++]&&(p=parseFloat(d[h-1])||0,c._pt={_next:c._pt,p:_||h===1?_:",",s:p,c:g.charAt(1)==="="?Nr(p,g)-p:parseFloat(g)-p,m:f&&f<4?Math.round:0},l=Fo.lastIndex);return c.c=l<i.length?i.substring(l,i.length):"",c.fp=o,(Md.test(i)||m)&&(c.e=0),this._pt=c,c},Yc=function(e,t,n,i,r,a,o,c,l,h){dt(i)&&(i=i(r||0,e,a));var u=e[t],d=n!=="get"?n:dt(u)?l?e[t.indexOf("set")||!dt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](l):e[t]():u,f=dt(u)?l?uy:Jd:Kc,g;if(Pt(i)&&(~i.indexOf("random(")&&(i=Cs(i)),i.charAt(1)==="="&&(g=Nr(d,i)+(kt(d)||0),(g||g===0)&&(i=g))),!h||d!==i||mc)return!isNaN(d*i)&&i!==""?(g=new Jt(this._pt,e,t,+d||0,i-(d||0),typeof u=="boolean"?fy:Qd,0,f),l&&(g.fp=l),o&&g.modifier(o,this,e),this._pt=g):(!u&&!(t in e)&&Hc(t,i),ay.call(this,e,t,d,i,f,c||ln.stringFilter,l))},oy=function(e,t,n,i,r){if(dt(e)&&(e=Ts(e,r,t,n,i)),!Fn(e)||e.style&&e.nodeType||zt(e)||xd(e))return Pt(e)?Ts(e,r,t,n,i):e;var a={},o;for(o in e)a[o]=Ts(e[o],r,t,n,i);return a},Kd=function(e,t,n,i,r,a){var o,c,l,h;if(sn[e]&&(o=new sn[e]).init(r,o.rawVars?t[e]:oy(t[e],i,r,a,n),n,i,a)!==!1&&(n._pt=c=new Jt(n._pt,r,e,0,1,o.render,o,0,o.priority),n!==Rr))for(l=n._ptLookup[n._targets.indexOf(r)],h=o._props.length;h--;)l[o._props[h]]=c;return o},gi,mc,jc=function s(e,t,n){var i=e.vars,r=i.ease,a=i.startAt,o=i.immediateRender,c=i.lazy,l=i.onUpdate,h=i.runBackwards,u=i.yoyoEase,d=i.keyframes,f=i.autoRevert,g=e._dur,_=e._startAt,p=e._targets,m=e.parent,y=m&&m.data==="nested"?m.vars.targets:p,x=e._overwrite==="auto"&&!Bc,M=e.timeline,E,A,T,R,L,v,w,B,k,P,F,N,Y;if(M&&(!d||!r)&&(r="none"),e._ease=tr(r,Yr.ease),e._yEase=u?Xd(tr(u===!0?r:u,Yr.ease)):0,u&&e._yoyo&&!e._repeat&&(u=e._yEase,e._yEase=e._ease,e._ease=u),e._from=!M&&!!i.runBackwards,!M||d&&!i.stagger){if(B=p[0]?Qi(p[0]).harness:0,N=B&&i[B.prop],E=Da(i,Vc),_&&(_._zTime<0&&_.progress(1),t<0&&h&&o&&!f?_.render(-1,!0):_.revert(h&&g?va:UM),_._lazy=0),a){if(wi(e._startAt=vt.set(p,un({data:"isStart",overwrite:!1,parent:m,immediateRender:!0,lazy:!_&&$t(c),startAt:null,delay:0,onUpdate:l&&function(){return on(e,"onUpdate")},stagger:0},a))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ut||!o&&!f)&&e._startAt.revert(va),o&&g&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(h&&g&&!_){if(t&&(o=!1),T=un({overwrite:!1,data:"isFromStart",lazy:o&&!_&&$t(c),immediateRender:o,stagger:0,parent:m},E),N&&(T[B.prop]=N),wi(e._startAt=vt.set(p,T)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ut?e._startAt.revert(va):e._startAt.render(-1,!0)),e._zTime=t,!o)s(e._startAt,Je,Je);else if(!t)return}for(e._pt=e._ptCache=0,c=g&&$t(c)||c&&!g,A=0;A<p.length;A++){if(L=p[A],w=L._gsap||Xc(p)[A]._gsap,e._ptLookup[A]=P={},lc[w.id]&&Ei.length&&La(),F=y===p?A:y.indexOf(L),B&&(k=new B).init(L,N||E,e,F,y)!==!1&&(e._pt=R=new Jt(e._pt,L,k.name,0,1,k.render,k,0,k.priority),k._props.forEach(function(X){P[X]=R}),k.priority&&(v=1)),!B||N)for(T in E)sn[T]&&(k=Kd(T,E,e,F,L,y))?k.priority&&(v=1):P[T]=R=Yc.call(e,L,T,"get",E[T],F,y,0,i.stringFilter);e._op&&e._op[A]&&e.kill(L,e._op[A]),x&&e._pt&&(gi=e,ht.killTweensOf(L,P,e.globalTime(t)),Y=!e.parent,gi=0),e._pt&&c&&(lc[w.id]=1)}v&&tf(e),e._onInit&&e._onInit(e)}e._onUpdate=l,e._initted=(!e._op||e._pt)&&!Y,d&&t<=0&&M.render(vn,!0,!0)},cy=function(e,t,n,i,r,a,o,c){var l=(e._pt&&e._ptCache||(e._ptCache={}))[t],h,u,d,f;if(!l)for(l=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(h=d[f][t],h&&h.d&&h.d._pt)for(h=h.d._pt;h&&h.p!==t&&h.fp!==t;)h=h._next;if(!h)return mc=1,e.vars[t]="+=0",jc(e,o),mc=0,c?ws(t+" not eligible for reset"):1;l.push(h)}for(f=l.length;f--;)u=l[f],h=u._pt||u,h.s=(i||i===0)&&!r?i:h.s+(i||0)+a*h.c,h.c=n-h.s,u.e&&(u.e=_t(n)+kt(u.e)),u.b&&(u.b=h.s+kt(u.b))},ly=function(e,t){var n=e[0]?Qi(e[0]).harness:0,i=n&&n.aliases,r,a,o,c;if(!i)return t;r=jr({},t);for(a in i)if(a in r)for(c=i[a].split(","),o=c.length;o--;)r[c[o]]=r[a];return r},hy=function(e,t,n,i){var r=t.ease||i||"power1.inOut",a,o;if(zt(t))o=n[e]||(n[e]=[]),t.forEach(function(c,l){return o.push({t:l/(t.length-1)*100,v:c,e:r})});else for(a in t)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(e),v:t[a],e:r})},Ts=function(e,t,n,i,r){return dt(e)?e.call(t,n,i,r):Pt(e)&&~e.indexOf("random(")?Cs(e):e},$d=Wc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Zd={};Zt($d+",id,stagger,delay,duration,paused,scrollTrigger",function(s){return Zd[s]=1});var vt=function(s){_d(e,s);function e(n,i,r,a){var o;typeof i=="number"&&(r.duration=i,i=r,r=null),o=s.call(this,a?i:ys(i))||this;var c=o.vars,l=c.duration,h=c.delay,u=c.immediateRender,d=c.stagger,f=c.overwrite,g=c.keyframes,_=c.defaults,p=c.scrollTrigger,m=c.yoyoEase,y=i.parent||ht,x=(zt(n)||xd(n)?ei(n[0]):"length"in i)?[n]:Mn(n),M,E,A,T,R,L,v,w;if(o._targets=x.length?Xc(x):ws("GSAP target "+n+" not found. https://gsap.com",!ln.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=f,g||d||pa(l)||pa(h)){if(i=o.vars,M=o.timeline=new Wt({data:"nested",defaults:_||{},targets:y&&y.data==="nested"?y.vars.targets:x}),M.kill(),M.parent=M._dp=jn(o),M._start=0,d||pa(l)||pa(h)){if(T=x.length,v=d&&Ud(d),Fn(d))for(R in d)~$d.indexOf(R)&&(w||(w={}),w[R]=d[R]);for(E=0;E<T;E++)A=Da(i,Zd),A.stagger=0,m&&(A.yoyoEase=m),w&&jr(A,w),L=x[E],A.duration=+Ts(l,jn(o),E,L,x),A.delay=(+Ts(h,jn(o),E,L,x)||0)-o._delay,!d&&T===1&&A.delay&&(o._delay=h=A.delay,o._start+=h,A.delay=0),M.to(L,A,v?v(E,L,x):0),M._ease=We.none;M.duration()?l=h=0:o.timeline=0}else if(g){ys(un(M.vars.defaults,{ease:"none"})),M._ease=tr(g.ease||i.ease||"none");var B=0,k,P,F;if(zt(g))g.forEach(function(N){return M.to(x,N,">")}),M.duration();else{A={};for(R in g)R==="ease"||R==="easeEach"||hy(R,g[R],A,g.easeEach);for(R in A)for(k=A[R].sort(function(N,Y){return N.t-Y.t}),B=0,E=0;E<k.length;E++)P=k[E],F={ease:P.e,duration:(P.t-(E?k[E-1].t:0))/100*l},F[R]=P.v,M.to(x,F,B),B+=F.duration;M.duration()<l&&M.to({},{duration:l-M.duration()})}}l||o.duration(l=M.duration())}else o.timeline=0;return f===!0&&!Bc&&(gi=jn(o),ht.killTweensOf(x),gi=0),Dn(y,jn(o),r),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!l&&!g&&o._start===lt(y._time)&&$t(u)&&GM(jn(o))&&y.data!=="nested")&&(o._tTime=-Je,o.render(Math.max(0,-h)||0)),p&&Ld(jn(o),p),o}var t=e.prototype;return t.render=function(i,r,a){var o=this._time,c=this._tDur,l=this._dur,h=i<0,u=i>c-Je&&!h?c:i<Je?0:i,d,f,g,_,p,m,y,x,M;if(!l)VM(this,i,r,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==h||this._lazy){if(d=u,x=this.timeline,this._repeat){if(_=l+this._rDelay,this._repeat<-1&&h)return this.totalTime(_*100+i,r,a);if(d=lt(u%_),u===c?(g=this._repeat,d=l):(p=lt(u/_),g=~~p,g&&g===p?(d=l,g--):d>l&&(d=l)),m=this._yoyo&&g&1,m&&(M=this._yEase,d=l-d),p=Kr(this._tTime,_),d===o&&!a&&this._initted&&g===p)return this._tTime=u,this;g!==p&&(x&&this._yEase&&qd(x,m),this.vars.repeatRefresh&&!m&&!this._lock&&d!==_&&this._initted&&(this._lock=a=1,this.render(lt(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(Dd(this,h?i:d,a,r,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==p))return this;if(l!==this._dur)return this.render(i,r,a)}if(this._tTime=u,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=y=(M||this._ease)(d/l),this._from&&(this.ratio=y=1-y),!o&&u&&!r&&!p&&(on(this,"onStart"),this._tTime!==u))return this;for(f=this._pt;f;)f.r(y,f.d),f=f._next;x&&x.render(i<0?i:x._dur*x._ease(d/this._dur),r,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!r&&(h&&hc(this,i,r,a),on(this,"onUpdate")),this._repeat&&g!==p&&this.vars.onRepeat&&!r&&this.parent&&on(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(h&&!this._onUpdate&&hc(this,i,!0,!0),(i||!l)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&wi(this,1),!r&&!(h&&!o)&&(u||o||m)&&(on(this,u===c?"onComplete":"onReverseComplete",!0),this._prom&&!(u<c&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),s.prototype.invalidate.call(this,i)},t.resetTo=function(i,r,a,o,c){Ps||an.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),h;return this._initted||jc(this,l),h=this._ease(l/this._dur),cy(this,i,r,a,o,h,l,c)?this.resetTo(i,r,a,o,1):(Xa(this,0),this.parent||Cd(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,r){if(r===void 0&&(r="all"),!i&&(!r||r==="all"))return this._lazy=this._pt=0,this.parent?ms(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Ut),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,r,gi&&gi.vars.overwrite!==!0)._first||ms(this),this.parent&&a!==this.timeline.totalDuration()&&$r(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,c=i?Mn(i):o,l=this._ptLookup,h=this._pt,u,d,f,g,_,p,m;if((!r||r==="all")&&kM(o,c))return r==="all"&&(this._pt=0),ms(this);for(u=this._op=this._op||[],r!=="all"&&(Pt(r)&&(_={},Zt(r,function(y){return _[y]=1}),r=_),r=ly(o,r)),m=o.length;m--;)if(~c.indexOf(o[m])){d=l[m],r==="all"?(u[m]=r,g=d,f={}):(f=u[m]=u[m]||{},g=r);for(_ in g)p=d&&d[_],p&&((!("kill"in p.d)||p.d.kill(_)===!0)&&Va(this,p,"_pt"),delete d[_]),f!=="all"&&(f[_]=1)}return this._initted&&!this._pt&&h&&ms(this),this},e.to=function(i,r){return new e(i,r,arguments[2])},e.from=function(i,r){return Ss(1,arguments)},e.delayedCall=function(i,r,a,o){return new e(r,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:r,onReverseComplete:r,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},e.fromTo=function(i,r,a){return Ss(2,arguments)},e.set=function(i,r){return r.duration=0,r.repeatDelay||(r.repeat=0),new e(i,r)},e.killTweensOf=function(i,r,a){return ht.killTweensOf(i,r,a)},e}(Ls);un(vt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Zt("staggerTo,staggerFrom,staggerFromTo",function(s){vt[s]=function(){var e=new Wt,t=dc.call(arguments,0);return t.splice(s==="staggerFromTo"?5:4,0,0),e[s].apply(e,t)}});var Kc=function(e,t,n){return e[t]=n},Jd=function(e,t,n){return e[t](n)},uy=function(e,t,n,i){return e[t](i.fp,n)},dy=function(e,t,n){return e.setAttribute(t,n)},$c=function(e,t){return dt(e[t])?Jd:kc(e[t])&&e.setAttribute?dy:Kc},Qd=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},fy=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},ef=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},Zc=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},py=function(e,t,n,i){for(var r=this._pt,a;r;)a=r._next,r.p===i&&r.modifier(e,t,n),r=a},my=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?Va(this,t,"_pt"):t.dep||(n=1),t=i;return!n},_y=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},tf=function(e){for(var t=e._pt,n,i,r,a;t;){for(n=t._next,i=r;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:a)?t._prev._next=t:r=t,(t._next=i)?i._prev=t:a=t,t=n}e._pt=r},Jt=function(){function s(t,n,i,r,a,o,c,l,h){this.t=n,this.s=r,this.c=a,this.p=i,this.r=o||Qd,this.d=c||this,this.set=l||Kc,this.pr=h||0,this._next=t,t&&(t._prev=this)}var e=s.prototype;return e.modifier=function(n,i,r){this.mSet=this.mSet||this.set,this.set=_y,this.m=n,this.mt=r,this.tween=i},s}();Zt(Wc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(s){return Vc[s]=1});hn.TweenMax=hn.TweenLite=vt;hn.TimelineLite=hn.TimelineMax=Wt;ht=new Wt({sortChildren:!1,defaults:Yr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});ln.stringFilter=Wd;var nr=[],ya={},gy=[],du=0,xy=0,Ho=function(e){return(ya[e]||gy).map(function(t){return t()})},_c=function(){var e=Date.now(),t=[];e-du>2&&(Ho("matchMediaInit"),nr.forEach(function(n){var i=n.queries,r=n.conditions,a,o,c,l;for(o in i)a=Cn.matchMedia(i[o]).matches,a&&(c=1),a!==r[o]&&(r[o]=a,l=1);l&&(n.revert(),c&&t.push(n))}),Ho("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),du=e,Ho("matchMedia"))},nf=function(){function s(t,n){this.selector=n&&fc(n),this.data=[],this._r=[],this.isReverted=!1,this.id=xy++,t&&this.add(t)}var e=s.prototype;return e.add=function(n,i,r){dt(n)&&(r=i,i=n,n=dt);var a=this,o=function(){var l=at,h=a.selector,u;return l&&l!==a&&l.data.push(a),r&&(a.selector=fc(r)),at=a,u=i.apply(a,arguments),dt(u)&&a._r.push(u),at=l,a.selector=h,a.isReverted=!1,u};return a.last=o,n===dt?o(a,function(c){return a.add(null,c)}):n?a[n]=o:o},e.ignore=function(n){var i=at;at=null,n(this),at=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof s?n.push.apply(n,i.getTweens()):i instanceof vt&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var r=this;if(n?function(){for(var o=r.getTweens(),c=r.data.length,l;c--;)l=r.data[c],l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(h){return o.splice(o.indexOf(h),1)}));for(o.map(function(h){return{g:h._dur||h._delay||h._sat&&!h._sat.vars.immediateRender?h.globalTime(0):-1/0,t:h}}).sort(function(h,u){return u.g-h.g||-1/0}).forEach(function(h){return h.t.revert(n)}),c=r.data.length;c--;)l=r.data[c],l instanceof Wt?l.data!=="nested"&&(l.scrollTrigger&&l.scrollTrigger.revert(),l.kill()):!(l instanceof vt)&&l.revert&&l.revert(n);r._r.forEach(function(h){return h(n,r)}),r.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=nr.length;a--;)nr[a].id===this.id&&nr.splice(a,1)},e.revert=function(n){this.kill(n||{})},s}(),vy=function(){function s(t){this.contexts=[],this.scope=t,at&&at.data.push(this)}var e=s.prototype;return e.add=function(n,i,r){Fn(n)||(n={matches:n});var a=new nf(0,r||this.scope),o=a.conditions={},c,l,h;at&&!a.selector&&(a.selector=at.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(l in n)l==="all"?h=1:(c=Cn.matchMedia(n[l]),c&&(nr.indexOf(a)<0&&nr.push(a),(o[l]=c.matches)&&(h=1),c.addListener?c.addListener(_c):c.addEventListener("change",_c)));return h&&i(a,function(u){return a.add(null,u)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},s}(),Na={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return Gd(i)})},timeline:function(e){return new Wt(e)},getTweensOf:function(e,t){return ht.getTweensOf(e,t)},getProperty:function(e,t,n,i){Pt(e)&&(e=Mn(e)[0]);var r=Qi(e||{}).get,a=n?Rd:wd;return n==="native"&&(n=""),e&&(t?a((sn[t]&&sn[t].get||r)(e,t,n,i)):function(o,c,l){return a((sn[o]&&sn[o].get||r)(e,o,c,l))})},quickSetter:function(e,t,n){if(e=Mn(e),e.length>1){var i=e.map(function(h){return en.quickSetter(h,t,n)}),r=i.length;return function(h){for(var u=r;u--;)i[u](h)}}e=e[0]||{};var a=sn[t],o=Qi(e),c=o.harness&&(o.harness.aliases||{})[t]||t,l=a?function(h){var u=new a;Rr._pt=0,u.init(e,n?h+n:h,Rr,0,[e]),u.render(1,u),Rr._pt&&Zc(1,Rr)}:o.set(e,c);return a?l:function(h){return l(e,c,n?h+n:h,o,1)}},quickTo:function(e,t,n){var i,r=en.to(e,un((i={},i[t]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(c,l,h){return r.resetTo(t,c,l,h)};return a.tween=r,a},isTweening:function(e){return ht.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=tr(e.ease,Yr.ease)),ou(Yr,e||{})},config:function(e){return ou(ln,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,r=e.defaults,a=e.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!sn[o]&&!hn[o]&&ws(t+" effect requires "+o+" plugin.")}),Bo[t]=function(o,c,l){return n(Mn(o),un(c||{},r),l)},a&&(Wt.prototype[t]=function(o,c,l){return this.add(Bo[t](o,Fn(c)?c:(l=c)&&{},this),l)})},registerEase:function(e,t){We[e]=tr(t)},parseEase:function(e,t){return arguments.length?tr(e,t):We},getById:function(e){return ht.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Wt(e),i,r;for(n.smoothChildTiming=$t(e.smoothChildTiming),ht.remove(n),n._dp=0,n._time=n._tTime=ht._time,i=ht._first;i;)r=i._next,(t||!(!i._dur&&i instanceof vt&&i.vars.onComplete===i._targets[0]))&&Dn(n,i,i._start-i._delay),i=r;return Dn(ht,n,0),n},context:function(e,t){return e?new nf(e,t):at},matchMedia:function(e){return new vy(e)},matchMediaRefresh:function(){return nr.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||_c()},addEventListener:function(e,t){var n=ya[e]||(ya[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=ya[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:ZM,wrapYoyo:JM,distribute:Ud,random:Fd,snap:Od,normalize:$M,getUnit:kt,clamp:qM,splitColor:Hd,toArray:Mn,selector:fc,mapRange:kd,pipe:jM,unitize:KM,interpolate:QM,shuffle:Nd},install:Sd,effects:Bo,ticker:an,updateRoot:Wt.updateRoot,plugins:sn,globalTimeline:ht,core:{PropTween:Jt,globals:Td,Tween:vt,Timeline:Wt,Animation:Ls,getCache:Qi,_removeLinkedListItem:Va,reverting:function(){return Ut},context:function(e){return e&&at&&(at.data.push(e),e._ctx=at),at},suppressOverwrites:function(e){return Bc=e}}};Zt("to,from,fromTo,delayedCall,set,killTweensOf",function(s){return Na[s]=vt[s]});an.add(Wt.updateRoot);Rr=Na.to({},{duration:0});var My=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},yy=function(e,t){var n=e._targets,i,r,a;for(i in t)for(r=n.length;r--;)a=e._ptLookup[r][i],a&&(a=a.d)&&(a._pt&&(a=My(a,i)),a&&a.modifier&&a.modifier(t[i],e,n[r],i))},Vo=function(e,t){return{name:e,headless:1,rawVars:1,init:function(i,r,a){a._onInit=function(o){var c,l;if(Pt(r)&&(c={},Zt(r,function(h){return c[h]=1}),r=c),t){c={};for(l in r)c[l]=t(r[l]);r=c}yy(o,r)}}}},en=Na.registerPlugin({name:"attr",init:function(e,t,n,i,r){var a,o,c;this.tween=n;for(a in t)c=e.getAttribute(a)||"",o=this.add(e,"setAttribute",(c||0)+"",t[a],i,r,0,0,a),o.op=a,o.b=c,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)Ut?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Vo("roundProps",pc),Vo("modifiers"),Vo("snap",Od))||Na;vt.version=Wt.version=en.version="3.14.2";yd=1;zc()&&Zr();We.Power0;We.Power1;We.Power2;We.Power3;We.Power4;We.Linear;We.Quad;We.Cubic;We.Quart;We.Quint;We.Strong;We.Elastic;We.Back;We.SteppedEase;We.Bounce;We.Sine;We.Expo;We.Circ;/*!
 * CSSPlugin 3.14.2
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var fu,xi,Ur,Jc,Ki,pu,Qc,Sy=function(){return typeof window<"u"},ti={},Xi=180/Math.PI,Or=Math.PI/180,Tr=Math.atan2,mu=1e8,el=/([A-Z])/g,Ty=/(left|right|width|margin|padding|x)/i,Ey=/[\s,\(]\S/,Nn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},gc=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},by=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Ay=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},wy=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Ry=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},rf=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},sf=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Cy=function(e,t,n){return e.style[t]=n},Py=function(e,t,n){return e.style.setProperty(t,n)},Ly=function(e,t,n){return e._gsap[t]=n},Dy=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Iy=function(e,t,n,i,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},Ny=function(e,t,n,i,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},ut="transform",Qt=ut+"Origin",Uy=function s(e,t){var n=this,i=this.target,r=i.style,a=i._gsap;if(e in ti&&r){if(this.tfm=this.tfm||{},e!=="transform")e=Nn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Kn(i,o)}):this.tfm[e]=a.x?a[e]:Kn(i,e),e===Qt&&(this.tfm.zOrigin=a.zOrigin);else return Nn.transform.split(",").forEach(function(o){return s.call(n,o,t)});if(this.props.indexOf(ut)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Qt,t,"")),e=ut}(r||t)&&this.props.push(e,t,r[e])},af=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Oy=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?e[r+1]===2?t[e[r]](e[r+2]):t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(el,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Qc(),(!r||!r.isStart)&&!n[ut]&&(af(n),i.zOrigin&&n[Qt]&&(n[Qt]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},of=function(e,t){var n={target:e,props:[],revert:Oy,save:Uy};return e._gsap||en.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},cf,xc=function(e,t){var n=xi.createElementNS?xi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):xi.createElement(e);return n&&n.style?n:xi.createElement(e)},cn=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(el,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,Jr(t)||t,1)||""},_u="O,Moz,ms,Ms,Webkit".split(","),Jr=function(e,t,n){var i=t||Ki,r=i.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(_u[a]+e in r););return a<0?null:(a===3?"ms":a>=0?_u[a]:"")+e},vc=function(){Sy()&&window.document&&(fu=window,xi=fu.document,Ur=xi.documentElement,Ki=xc("div")||{style:{}},xc("div"),ut=Jr(ut),Qt=ut+"Origin",Ki.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",cf=!!Jr("perspective"),Qc=en.core.reverting,Jc=1)},gu=function(e){var t=e.ownerSVGElement,n=xc("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),r;i.style.display="block",n.appendChild(i),Ur.appendChild(n);try{r=i.getBBox()}catch{}return n.removeChild(i),Ur.removeChild(n),r},xu=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},lf=function(e){var t,n;try{t=e.getBBox()}catch{t=gu(e),n=1}return t&&(t.width||t.height)||n||(t=gu(e)),t&&!t.width&&!t.x&&!t.y?{x:+xu(e,["x","cx","x1"])||0,y:+xu(e,["y","cy","y1"])||0,width:0,height:0}:t},hf=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&lf(e))},Ri=function(e,t){if(t){var n=e.style,i;t in ti&&t!==Qt&&(t=ut),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(el,"-$1").toLowerCase())):n.removeAttribute(t)}},vi=function(e,t,n,i,r,a){var o=new Jt(e._pt,t,n,0,1,a?sf:rf);return e._pt=o,o.b=i,o.e=r,e._props.push(n),o},vu={deg:1,rad:1,turn:1},Fy={grid:1,flex:1},Ci=function s(e,t,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=Ki.style,c=Ty.test(t),l=e.tagName.toLowerCase()==="svg",h=(l?"client":"offset")+(c?"Width":"Height"),u=100,d=i==="px",f=i==="%",g,_,p,m;if(i===a||!r||vu[i]||vu[a])return r;if(a!=="px"&&!d&&(r=s(e,t,n,"px")),m=e.getCTM&&hf(e),(f||a==="%")&&(ti[t]||~t.indexOf("adius")))return g=m?e.getBBox()[c?"width":"height"]:e[h],_t(f?r/g*u:r/100*g);if(o[c?"width":"height"]=u+(d?a:i),_=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,m&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===xi||!_.appendChild)&&(_=xi.body),p=_._gsap,p&&f&&p.width&&c&&p.time===an.time&&!p.uncache)return _t(r/p.width*u);if(f&&(t==="height"||t==="width")){var y=e.style[t];e.style[t]=u+i,g=e[h],y?e.style[t]=y:Ri(e,t)}else(f||a==="%")&&!Fy[cn(_,"display")]&&(o.position=cn(e,"position")),_===e&&(o.position="static"),_.appendChild(Ki),g=Ki[h],_.removeChild(Ki),o.position="absolute";return c&&f&&(p=Qi(_),p.time=an.time,p.width=_[h]),_t(d?g*r/u:g&&r?u/g*r:0)},Kn=function(e,t,n,i){var r;return Jc||vc(),t in Nn&&t!=="transform"&&(t=Nn[t],~t.indexOf(",")&&(t=t.split(",")[0])),ti[t]&&t!=="transform"?(r=Is(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:Oa(cn(e,Qt))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=Ua[t]&&Ua[t](e,t,n)||cn(e,t)||bd(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?Ci(e,t,r,n)+n:r},By=function(e,t,n,i){if(!n||n==="none"){var r=Jr(t,e,1),a=r&&cn(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=cn(e,"borderTopColor"))}var o=new Jt(this._pt,e.style,t,0,1,ef),c=0,l=0,h,u,d,f,g,_,p,m,y,x,M,E;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=cn(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=e.style[t],e.style[t]=i,i=cn(e,t)||i,_?e.style[t]=_:Ri(e,t)),h=[n,i],Wd(h),n=h[0],i=h[1],d=n.match(wr)||[],E=i.match(wr)||[],E.length){for(;u=wr.exec(i);)p=u[0],y=i.substring(c,u.index),g?g=(g+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(g=1),p!==(_=d[l++]||"")&&(f=parseFloat(_)||0,M=_.substr((f+"").length),p.charAt(1)==="="&&(p=Nr(f,p)+M),m=parseFloat(p),x=p.substr((m+"").length),c=wr.lastIndex-x.length,x||(x=x||ln.units[t]||M,c===i.length&&(i+=x,o.e+=x)),M!==x&&(f=Ci(e,t,_,x)||0),o._pt={_next:o._pt,p:y||l===1?y:",",s:f,c:m-f,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=c<i.length?i.substring(c,i.length):""}else o.r=t==="display"&&i==="none"?sf:rf;return Md.test(i)&&(o.e=0),this._pt=o,o},Mu={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},ky=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Mu[n]||n,t[1]=Mu[i]||i,t.join(" ")},zy=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,a=n._gsap,o,c,l;if(r==="all"||r===!0)i.cssText="",c=1;else for(r=r.split(","),l=r.length;--l>-1;)o=r[l],ti[o]&&(c=1,o=o==="transformOrigin"?Qt:ut),Ri(n,o);c&&(Ri(n,ut),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Is(n,1),a.uncache=1,af(i)))}},Ua={clearProps:function(e,t,n,i,r){if(r.data!=="isFromStart"){var a=e._pt=new Jt(e._pt,t,n,0,0,zy);return a.u=i,a.pr=-10,a.tween=r,e._props.push(n),1}}},Ds=[1,0,0,1,0,0],uf={},df=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},yu=function(e){var t=cn(e,ut);return df(t)?Ds:t.substr(7).match(vd).map(_t)},tl=function(e,t){var n=e._gsap||Qi(e),i=e.style,r=yu(e),a,o,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,r=[c.a,c.b,c.c,c.d,c.e,c.f],r.join(",")==="1,0,0,1,0,0"?Ds:r):(r===Ds&&!e.offsetParent&&e!==Ur&&!n.svg&&(c=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(l=1,o=e.nextElementSibling,Ur.appendChild(e)),r=yu(e),c?i.display=c:Ri(e,"display"),l&&(o?a.insertBefore(e,o):a?a.appendChild(e):Ur.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Mc=function(e,t,n,i,r,a){var o=e._gsap,c=r||tl(e,!0),l=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=c[0],g=c[1],_=c[2],p=c[3],m=c[4],y=c[5],x=t.split(" "),M=parseFloat(x[0])||0,E=parseFloat(x[1])||0,A,T,R,L;n?c!==Ds&&(T=f*p-g*_)&&(R=M*(p/T)+E*(-_/T)+(_*y-p*m)/T,L=M*(-g/T)+E*(f/T)-(f*y-g*m)/T,M=R,E=L):(A=lf(e),M=A.x+(~x[0].indexOf("%")?M/100*A.width:M),E=A.y+(~(x[1]||x[0]).indexOf("%")?E/100*A.height:E)),i||i!==!1&&o.smooth?(m=M-l,y=E-h,o.xOffset=u+(m*f+y*_)-m,o.yOffset=d+(m*g+y*p)-y):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=E,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[Qt]="0px 0px",a&&(vi(a,o,"xOrigin",l,M),vi(a,o,"yOrigin",h,E),vi(a,o,"xOffset",u,o.xOffset),vi(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",M+" "+E)},Is=function(e,t){var n=e._gsap||new jd(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,a="px",o="deg",c=getComputedStyle(e),l=cn(e,Qt)||"0",h,u,d,f,g,_,p,m,y,x,M,E,A,T,R,L,v,w,B,k,P,F,N,Y,X,j,K,ee,ie,_e,G,Z;return h=u=d=_=p=m=y=x=M=0,f=g=1,n.svg=!!(e.getCTM&&hf(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[ut]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[ut]!=="none"?c[ut]:"")),i.scale=i.rotate=i.translate="none"),T=tl(e,n.svg),n.svg&&(n.uncache?(X=e.getBBox(),l=n.xOrigin-X.x+"px "+(n.yOrigin-X.y)+"px",Y=""):Y=!t&&e.getAttribute("data-svg-origin"),Mc(e,Y||l,!!Y||n.originIsAbsolute,n.smooth!==!1,T)),E=n.xOrigin||0,A=n.yOrigin||0,T!==Ds&&(w=T[0],B=T[1],k=T[2],P=T[3],h=F=T[4],u=N=T[5],T.length===6?(f=Math.sqrt(w*w+B*B),g=Math.sqrt(P*P+k*k),_=w||B?Tr(B,w)*Xi:0,y=k||P?Tr(k,P)*Xi+_:0,y&&(g*=Math.abs(Math.cos(y*Or))),n.svg&&(h-=E-(E*w+A*k),u-=A-(E*B+A*P))):(Z=T[6],_e=T[7],K=T[8],ee=T[9],ie=T[10],G=T[11],h=T[12],u=T[13],d=T[14],R=Tr(Z,ie),p=R*Xi,R&&(L=Math.cos(-R),v=Math.sin(-R),Y=F*L+K*v,X=N*L+ee*v,j=Z*L+ie*v,K=F*-v+K*L,ee=N*-v+ee*L,ie=Z*-v+ie*L,G=_e*-v+G*L,F=Y,N=X,Z=j),R=Tr(-k,ie),m=R*Xi,R&&(L=Math.cos(-R),v=Math.sin(-R),Y=w*L-K*v,X=B*L-ee*v,j=k*L-ie*v,G=P*v+G*L,w=Y,B=X,k=j),R=Tr(B,w),_=R*Xi,R&&(L=Math.cos(R),v=Math.sin(R),Y=w*L+B*v,X=F*L+N*v,B=B*L-w*v,N=N*L-F*v,w=Y,F=X),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,m=180-m),f=_t(Math.sqrt(w*w+B*B+k*k)),g=_t(Math.sqrt(N*N+Z*Z)),R=Tr(F,N),y=Math.abs(R)>2e-4?R*Xi:0,M=G?1/(G<0?-G:G):0),n.svg&&(Y=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!df(cn(e,ut)),Y&&e.setAttribute("transform",Y))),Math.abs(y)>90&&Math.abs(y)<270&&(r?(f*=-1,y+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,y+=y<=0?180:-180)),t=t||n.uncache,n.x=h-((n.xPercent=h&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-h)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=_t(f),n.scaleY=_t(g),n.rotation=_t(_)+o,n.rotationX=_t(p)+o,n.rotationY=_t(m)+o,n.skewX=y+o,n.skewY=x+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Qt]=Oa(l)),n.xOffset=n.yOffset=0,n.force3D=ln.force3D,n.renderTransform=n.svg?Hy:cf?ff:Gy,n.uncache=0,n},Oa=function(e){return(e=e.split(" "))[0]+" "+e[1]},Wo=function(e,t,n){var i=kt(t);return _t(parseFloat(t)+parseFloat(Ci(e,"x",n+"px",i)))+i},Gy=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,ff(e,t)},Gi="0deg",fs="0px",Hi=") ",ff=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,c=n.z,l=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,m=n.force3D,y=n.target,x=n.zOrigin,M="",E=m==="auto"&&e&&e!==1||m===!0;if(x&&(u!==Gi||h!==Gi)){var A=parseFloat(h)*Or,T=Math.sin(A),R=Math.cos(A),L;A=parseFloat(u)*Or,L=Math.cos(A),a=Wo(y,a,T*L*-x),o=Wo(y,o,-Math.sin(A)*-x),c=Wo(y,c,R*L*-x+x)}p!==fs&&(M+="perspective("+p+Hi),(i||r)&&(M+="translate("+i+"%, "+r+"%) "),(E||a!==fs||o!==fs||c!==fs)&&(M+=c!==fs||E?"translate3d("+a+", "+o+", "+c+") ":"translate("+a+", "+o+Hi),l!==Gi&&(M+="rotate("+l+Hi),h!==Gi&&(M+="rotateY("+h+Hi),u!==Gi&&(M+="rotateX("+u+Hi),(d!==Gi||f!==Gi)&&(M+="skew("+d+", "+f+Hi),(g!==1||_!==1)&&(M+="scale("+g+", "+_+Hi),y.style[ut]=M||"translate(0, 0)"},Hy=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,c=n.rotation,l=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,m=n.yOffset,y=n.forceCSS,x=parseFloat(a),M=parseFloat(o),E,A,T,R,L;c=parseFloat(c),l=parseFloat(l),h=parseFloat(h),h&&(h=parseFloat(h),l+=h,c+=h),c||l?(c*=Or,l*=Or,E=Math.cos(c)*u,A=Math.sin(c)*u,T=Math.sin(c-l)*-d,R=Math.cos(c-l)*d,l&&(h*=Or,L=Math.tan(l-h),L=Math.sqrt(1+L*L),T*=L,R*=L,h&&(L=Math.tan(h),L=Math.sqrt(1+L*L),E*=L,A*=L)),E=_t(E),A=_t(A),T=_t(T),R=_t(R)):(E=u,R=d,A=T=0),(x&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(x=Ci(f,"x",a,"px"),M=Ci(f,"y",o,"px")),(g||_||p||m)&&(x=_t(x+g-(g*E+_*T)+p),M=_t(M+_-(g*A+_*R)+m)),(i||r)&&(L=f.getBBox(),x=_t(x+i/100*L.width),M=_t(M+r/100*L.height)),L="matrix("+E+","+A+","+T+","+R+","+x+","+M+")",f.setAttribute("transform",L),y&&(f.style[ut]=L)},Vy=function(e,t,n,i,r){var a=360,o=Pt(r),c=parseFloat(r)*(o&&~r.indexOf("rad")?Xi:1),l=c-i,h=i+l+"deg",u,d;return o&&(u=r.split("_")[1],u==="short"&&(l%=a,l!==l%(a/2)&&(l+=l<0?a:-a)),u==="cw"&&l<0?l=(l+a*mu)%a-~~(l/a)*a:u==="ccw"&&l>0&&(l=(l-a*mu)%a-~~(l/a)*a)),e._pt=d=new Jt(e._pt,t,n,i,l,by),d.e=h,d.u="deg",e._props.push(n),d},Su=function(e,t){for(var n in t)e[n]=t[n];return e},Wy=function(e,t,n){var i=Su({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,c,l,h,u,d,f,g;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),a[ut]=t,o=Is(n,1),Ri(n,ut),n.setAttribute("transform",l)):(l=getComputedStyle(n)[ut],a[ut]=t,o=Is(n,1),a[ut]=l);for(c in ti)l=i[c],h=o[c],l!==h&&r.indexOf(c)<0&&(f=kt(l),g=kt(h),u=f!==g?Ci(n,c,l,g):parseFloat(l),d=parseFloat(h),e._pt=new Jt(e._pt,o,c,u,d-u,gc),e._pt.u=g||0,e._props.push(c));Su(o,i)};Zt("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",a=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(o){return e<2?s+o:"border"+o+s});Ua[e>1?"border"+s:s]=function(o,c,l,h,u){var d,f;if(arguments.length<4)return d=a.map(function(g){return Kn(o,g,l)}),f=d.join(" "),f.split(d[0]).length===5?d[0]:f;d=(h+"").split(" "),f={},a.forEach(function(g,_){return f[g]=d[_]=d[_]||d[(_-1)/2|0]}),o.init(c,f,u)}});var pf={name:"css",register:vc,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,r){var a=this._props,o=e.style,c=n.vars.startAt,l,h,u,d,f,g,_,p,m,y,x,M,E,A,T,R,L;Jc||vc(),this.styles=this.styles||of(e),R=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(h=t[_],!(sn[_]&&Kd(_,t,n,i,e,r)))){if(f=typeof h,g=Ua[_],f==="function"&&(h=h.call(n,i,e,r),f=typeof h),f==="string"&&~h.indexOf("random(")&&(h=Cs(h)),g)g(this,e,_,h,n)&&(T=1);else if(_.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(_)+"").trim(),h+="",bi.lastIndex=0,bi.test(l)||(p=kt(l),m=kt(h),m?p!==m&&(l=Ci(e,_,l,m)+m):p&&(h+=p)),this.add(o,"setProperty",l,h,i,r,0,0,_),a.push(_),R.push(_,0,o[_]);else if(f!=="undefined"){if(c&&_ in c?(l=typeof c[_]=="function"?c[_].call(n,i,e,r):c[_],Pt(l)&&~l.indexOf("random(")&&(l=Cs(l)),kt(l+"")||l==="auto"||(l+=ln.units[_]||kt(Kn(e,_))||""),(l+"").charAt(1)==="="&&(l=Kn(e,_))):l=Kn(e,_),d=parseFloat(l),y=f==="string"&&h.charAt(1)==="="&&h.substr(0,2),y&&(h=h.substr(2)),u=parseFloat(h),_ in Nn&&(_==="autoAlpha"&&(d===1&&Kn(e,"visibility")==="hidden"&&u&&(d=0),R.push("visibility",0,o.visibility),vi(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=Nn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in ti,x){if(this.styles.save(_),L=h,f==="string"&&h.substring(0,6)==="var(--"){if(h=cn(e,h.substring(4,h.indexOf(")"))),h.substring(0,5)==="calc("){var v=e.style.perspective;e.style.perspective=h,h=cn(e,"perspective"),v?e.style.perspective=v:Ri(e,"perspective")}u=parseFloat(h)}if(M||(E=e._gsap,E.renderTransform&&!t.parseTransform||Is(e,t.parseTransform),A=t.smoothOrigin!==!1&&E.smooth,M=this._pt=new Jt(this._pt,o,ut,0,1,E.renderTransform,E,0,-1),M.dep=1),_==="scale")this._pt=new Jt(this._pt,E,"scaleY",E.scaleY,(y?Nr(E.scaleY,y+u):u)-E.scaleY||0,gc),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){R.push(Qt,0,o[Qt]),h=ky(h),E.svg?Mc(e,h,0,A,0,this):(m=parseFloat(h.split(" ")[2])||0,m!==E.zOrigin&&vi(this,E,"zOrigin",E.zOrigin,m),vi(this,o,_,Oa(l),Oa(h)));continue}else if(_==="svgOrigin"){Mc(e,h,1,A,0,this);continue}else if(_ in uf){Vy(this,E,_,d,y?Nr(d,y+h):h);continue}else if(_==="smoothOrigin"){vi(this,E,"smooth",E.smooth,h);continue}else if(_==="force3D"){E[_]=h;continue}else if(_==="transform"){Wy(this,h,e);continue}}else _ in o||(_=Jr(_)||_);if(x||(u||u===0)&&(d||d===0)&&!Ey.test(h)&&_ in o)p=(l+"").substr((d+"").length),u||(u=0),m=kt(h)||(_ in ln.units?ln.units[_]:p),p!==m&&(d=Ci(e,_,l,m)),this._pt=new Jt(this._pt,x?E:o,_,d,(y?Nr(d,y+u):u)-d,!x&&(m==="px"||_==="zIndex")&&t.autoRound!==!1?Ry:gc),this._pt.u=m||0,x&&L!==h?(this._pt.b=l,this._pt.e=L,this._pt.r=wy):p!==m&&m!=="%"&&(this._pt.b=l,this._pt.r=Ay);else if(_ in o)By.call(this,e,_,l,y?y+h:h);else if(_ in e)this.add(e,_,l||e[_],y?y+h:h,i,r);else if(_!=="parseTransform"){Hc(_,h);continue}x||(_ in o?R.push(_,0,o[_]):typeof e[_]=="function"?R.push(_,2,e[_]()):R.push(_,1,l||e[_])),a.push(_)}}T&&tf(this)},render:function(e,t){if(t.tween._time||!Qc())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Kn,aliases:Nn,getSetter:function(e,t,n){var i=Nn[t];return i&&i.indexOf(",")<0&&(t=i),t in ti&&t!==Qt&&(e._gsap.x||Kn(e,"x"))?n&&pu===n?t==="scale"?Dy:Ly:(pu=n||{})&&(t==="scale"?Iy:Ny):e.style&&!kc(e.style[t])?Cy:~t.indexOf("-")?Py:$c(e,t)},core:{_removeProperty:Ri,_getMatrix:tl}};en.utils.checkPrefix=Jr;en.core.getStyleSaver=of;(function(s,e,t,n){var i=Zt(s+","+e+","+t,function(r){ti[r]=1});Zt(e,function(r){ln.units[r]="deg",uf[r]=1}),Nn[i[13]]=s+","+e,Zt(n,function(r){var a=r.split(":");Nn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Zt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){ln.units[s]="px"});en.registerPlugin(pf);var mf=en.registerPlugin(pf)||en;mf.core.Tween;const Xy=.06,qy=8e-4;class Yy{constructor(){this.targetProgress=0,this.progress=0,this.scrollSpeed=qy,this._tw=null,this._onWheel=this._onWheel.bind(this),this._onKeyDown=this._onKeyDown.bind(this),this._touch={active:!1,lastY:0},window.addEventListener("wheel",this._onWheel,{passive:!1}),window.addEventListener("keydown",this._onKeyDown),window.addEventListener("touchstart",this._onTouchStart.bind(this),{passive:!0}),window.addEventListener("touchmove",this._onTouchMove.bind(this),{passive:!1}),window.addEventListener("touchend",this._onTouchEnd.bind(this),{passive:!0})}_onWheel(e){e.preventDefault();const t=e.deltaY*this.scrollSpeed;this.targetProgress=Math.min(1,Math.max(0,this.targetProgress+t))}_onKeyDown(e){e.key==="ArrowDown"||e.key==="PageDown"?(e.preventDefault(),this.targetProgress=Math.min(1,this.targetProgress+.08)):e.key==="ArrowUp"||e.key==="PageUp"?(e.preventDefault(),this.targetProgress=Math.max(0,this.targetProgress-.08)):e.key==="Home"?(e.preventDefault(),this.targetProgress=0):e.key==="End"&&(e.preventDefault(),this.targetProgress=1)}_onTouchStart(e){e.touches.length&&(this._touch.active=!0,this._touch.lastY=e.touches[0].clientY)}_onTouchMove(e){if(!this._touch.active||!e.touches.length)return;e.preventDefault();const t=e.touches[0].clientY,n=this._touch.lastY-t;this._touch.lastY=t,this.targetProgress=Math.min(1,Math.max(0,this.targetProgress+n*this.scrollSpeed*1.2))}_onTouchEnd(){this._touch.active=!1}update(){this._tw||(this.progress+=(this.targetProgress-this.progress)*Xy)}getTowerY(){return-(this.progress*kv)}goTo(e,t=1.2){const n=Math.min(1,Math.max(0,e));this._tw&&this._tw.kill();const i={p:this.progress};this._tw=mf.to(i,{p:n,duration:t,ease:"power2.inOut",onUpdate:()=>{this.progress=i.p,this.targetProgress=i.p},onComplete:()=>{this.progress=n,this.targetProgress=n,this._tw=null}})}}class jy{constructor(){this.activeFloorIndex=0}getFloorIndex(e){const t=Math.min(1,Math.max(0,e)),n=Math.floor(t*Qh);return Math.min(Qh-1,n)}update(e){const t=this.getFloorIndex(e),n=t!==this.activeFloorIndex;return this.activeFloorIndex=t,n}}class Ky{constructor(){this.panels=[...document.querySelectorAll(".story-panel")],this.navDots=[...document.querySelectorAll("#floor-nav .nav-dot")],this.onNavClick=null,this.navDots.forEach((e,t)=>{e.addEventListener("click",()=>{this.onNavClick&&this.onNavClick(t)})})}setActivePanel(e){this.panels.forEach((t,n)=>t.classList.toggle("active",n===e)),this.navDots.forEach((t,n)=>t.classList.toggle("active",n===e))}}class $y{constructor(){this.ctx=null,this.source=null,this.gainNode=null,this.filterNode=null,this.buffer=null,this._rawBuffer=null,this.isPlaying=!1,this._loadError=null}async loadTrack(e){this._loadError=null;try{const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status}`);this._rawBuffer=await t.arrayBuffer()}catch(t){this._loadError=t,this._rawBuffer=null}}async play(){if(!this.isPlaying&&this._rawBuffer){if(!this.ctx){this.ctx=new AudioContext;const e=this._rawBuffer.slice(0);this.buffer=await this.ctx.decodeAudioData(e)}this.ctx.state==="suspended"&&await this.ctx.resume(),this.source=this.ctx.createBufferSource(),this.source.buffer=this.buffer,this.source.loop=!0,this.gainNode||(this.gainNode=this.ctx.createGain(),this.gainNode.gain.value=.2,this.filterNode=this.ctx.createBiquadFilter(),this.filterNode.type="lowpass",this.filterNode.frequency.value=800,this.filterNode.connect(this.gainNode),this.gainNode.connect(this.ctx.destination)),this.source.connect(this.filterNode),this.source.start(0),this.isPlaying=!0}}pause(){if(!(!this.isPlaying||!this.source)){try{this.source.stop()}catch{}this.source.disconnect(),this.source=null,this.isPlaying=!1}}async toggle(){this.isPlaying?this.pause():await this.play()}updateWithProgress(e){if(!this.isPlaying||!this.filterNode||!this.gainNode||!this.ctx)return;let t;e<.7?t=800+e/.7*19200:t=2e4-(e-.7)/.3*8e3,this.filterNode.frequency.setTargetAtTime(t,this.ctx.currentTime,.1);let n;e<.6?n=.2+e/.6*.4:e<.8?n=.6:n=.6-(e-.8)/.2*.25,this.gainNode.gain.setTargetAtTime(n,this.ctx.currentTime,.1)}}const Tu=[9118976,1785707,2972199,13216110,4861291,13421772];class Zy{constructor(){this.group=new xn,this.group.name="library-interior",this._textureMaterials=[],this._bookshelfFrontMat=this._stdMat({color:7037016,roughness:.9,transparent:!0,opacity:.96}),this._bookshelfFrontMat.userData.textureHint="bookshelf_books",this._textureMaterials.push(this._bookshelfFrontMat),this._buildTable(),this._buildTableProps(),this._buildChairs(),this._buildCharacterOwen(),this._buildCharacterYilin(),this._buildBookshelves(),this._buildWindow(),this._buildOverheadLight(),this._buildExtras(),this._loadOptionalTextures()}_stdMat(e){return new ts({metalness:0,...e})}_addMesh(e){e.castShadow=!0,e.receiveShadow=!0,this.group.add(e)}_loadOptionalTextures(){var i;const e=new Ic,t="/textures/library/",n=(r,a)=>{!a||!a.isMeshStandardMaterial||e.load(`${t}${r}`,o=>{o.colorSpace=Mt,a.map=o,a.needsUpdate=!0},void 0,()=>{})};for(const r of this._textureMaterials){const a=(i=r.userData)==null?void 0:i.textureHint;a==="wood_desk"&&n("wood_desk.jpg",r),a==="mcgill_red"&&n("mcgill_red.jpg",r),a==="grey_sweater"&&n("grey_sweater.jpg",r),a==="window_glow"&&n("window_glow.jpg",r),a==="bookshelf_books"&&n("bookshelf_books.jpg",r)}}_buildTable(){const e=this._stdMat({color:9137998,roughness:.75});e.userData.textureHint="wood_desk",this._textureMaterials.push(e);const t=new ue(new nt(2.2,.07,1),e);t.position.set(0,.82,.3),this._addMesh(t);const n=new nt(.07,.78,.07),i=this._stdMat({color:7033668,roughness:.8}),r=[[-.95,.39,-.38],[.95,.39,-.38],[-.95,.39,.38],[.95,.39,.38]];for(const[a,o,c]of r){const l=new ue(n,i);l.position.set(a,o,c),this._addMesh(l)}}_buildTableProps(){const e=new ue(new nt(.25,.02,.18),this._stdMat({color:16117984,roughness:.9}));e.position.set(-.4,.87,.3),e.rotation.y=.1,this._addMesh(e);const t=new ue(new nt(.2,.06,.15),this._stdMat({color:2968186,roughness:.85}));t.position.set(.4,.88,.3),this._addMesh(t);const n=new ue(new It(.008,.008,.18,6),this._stdMat({color:15255616,roughness:.5}));n.position.set(-.15,.86,.15),n.rotation.z=Math.PI/2,n.rotation.y=.3,this._addMesh(n)}_buildChairAt(e,t){const n=this._stdMat({color:7036239,roughness:.88}),i=new ue(new nt(.38,.04,.35),n);i.position.set(e,.42,t),this._addMesh(i);const r=new ue(new nt(.38,.4,.04),n);r.position.set(e,.64,t-.15),this._addMesh(r);const a=new It(.02,.02,.42,6),o=.16,c=.14;for(const[l,h]of[[-o,-c],[o,-c],[-o,c],[o,c]]){const u=new ue(a,n);u.position.set(e+l,.21,t+h),this._addMesh(u)}}_buildChairs(){this._buildChairAt(-.55,.75),this._buildChairAt(.55,.75)}_buildCharacterOwen(){const n=this._stdMat({color:15538980,roughness:.9});n.userData.textureHint="mcgill_red",this._textureMaterials.push(n);const i=new ue(new nt(.32,.35,.22),n);i.position.set(-.55,.95,.3),this._addMesh(i);const r=new ue(new mi(.12,12,10),this._stdMat({color:16109737,roughness:.8}));r.position.set(-.55,1.25,.3),this._addMesh(r);const a=new ue(new mi(.125,12,8,0,Math.PI*2,0,Math.PI/2),this._stdMat({color:2760468,roughness:.9}));a.position.set(-.55,1.3,.3),this._addMesh(a);const o=this._stdMat({color:15538980,roughness:.9}),c=new It(.04,.04,.28,8),l=new ue(c,o);l.position.set(-.22,.88,.3),l.rotation.z=-.5,this._addMesh(l);const h=new ue(c,o);h.position.set(0,.88,.3),h.rotation.z=.5,this._addMesh(h);const u=new nt(.12,.25,.18),d=this._stdMat({color:3816016,roughness:.9}),f=new ue(u,d);f.position.set(-.55-.08,.52,.3),this._addMesh(f);const g=new ue(u,d);g.position.set(-.55+.08,.52,.3),this._addMesh(g)}_buildCharacterYilin(){const n=this._stdMat({color:9211020,roughness:.9});n.userData.textureHint="grey_sweater",this._textureMaterials.push(n);const i=new ue(new nt(.28,.32,.2),n);i.position.set(.55,.93,.3),this._addMesh(i);const r=new ue(new mi(.11,12,10),this._stdMat({color:16109737,roughness:.8}));r.position.set(.55,1.22,.3),this._addMesh(r);const a=new ue(new mi(.13,12,10),this._stdMat({color:1708048,roughness:.85}));a.position.set(.55,1.25,.3),a.scale.set(1,.9,1.1),this._addMesh(a);const o=this._stdMat({color:9211020,roughness:.9}),c=new It(.035,.035,.26,8),l=new ue(c,o);l.position.set(.22,.88,.3),l.rotation.z=.5,this._addMesh(l);const h=new ue(c,o);h.position.set(.88,.88,.3),h.rotation.z=-.5,this._addMesh(h);const u=new nt(.11,.24,.17),d=this._stdMat({color:3816016,roughness:.9}),f=new ue(u,d);f.position.set(.55-.07,.51,.3),this._addMesh(f);const g=new ue(u,d);g.position.set(.55+.07,.51,.3),this._addMesh(g)}_buildBookshelfUnit(e,t){const n=this._stdMat({color:5918274,roughness:.85}),i=new ue(new nt(.9,3.2,.5),n);i.position.set(e,1.6,t),this._addMesh(i);const r=[.5,1.2,1.9,2.6];for(const c of r){const l=new ue(new nt(.84,.03,.46),n);l.position.set(e,c,t),this._addMesh(l)}const a=new ue(new Ji(.82,3),this._bookshelfFrontMat);a.position.set(e,1.55,t+.26),this._addMesh(a);let o=0;for(const c of r){let l=-.32;const h=6;for(let u=0;u<h;u++){const d=.06+u%3*.015,f=.18+u%4*.025,g=.16,_=Tu[o%Tu.length];o++;const p=new ue(new nt(d,f,g),this._stdMat({color:_,roughness:.75}));p.position.set(e+l+d/2,c+.03+f/2,t+.06),l+=d+.012,this._addMesh(p)}}}_buildBookshelves(){this._buildBookshelfUnit(-1.6,-1.8),this._buildBookshelfUnit(1.6,-1.8)}_buildWindow(){const e=new ue(new nt(1.2,1.4,.06),this._stdMat({color:13945016,roughness:.75}));e.position.set(-2.38,2,-.5),e.rotation.y=Math.PI/2,this._addMesh(e);const t=this._stdMat({color:16775392,emissive:16772795,emissiveIntensity:.5,transparent:!0,opacity:.85,roughness:.2});t.userData.textureHint="window_glow",this._textureMaterials.push(t);const n=new ue(new Ji(1,1.2),t);n.position.set(-2.35,2,-.5),n.rotation.y=Math.PI/2,this._addMesh(n);const i=new ue(new nt(1,.03,.03),this._stdMat({color:13945016,roughness:.75}));i.position.set(-2.32,2,-.5),i.rotation.y=Math.PI/2,this._addMesh(i);const r=new ue(new nt(.03,1.2,.03),this._stdMat({color:13945016,roughness:.75}));r.position.set(-2.32,2,-.5),r.rotation.y=Math.PI/2,this._addMesh(r)}_buildOverheadLight(){const e=this._stdMat({color:2763306,roughness:.45,metalness:.35}),t=new ue(new It(.15,.08,.06,12),e);t.position.set(0,4.1,.3),this._addMesh(t);const n=new ue(new It(.008,.008,.4,4),this._stdMat({color:2236962,roughness:.9}));n.position.set(0,4.3,.3),this._addMesh(n);const i=new Uc(16773332,1.2,6,2);i.position.set(0,3.8,.3),this.group.add(i);const r=new ot;r.position.set(0,.82,.3),this.group.add(r);const a=new fd(16773332,.8,12,Math.PI/5,.6,1.2);a.position.set(0,4,.3),a.target=r,a.castShadow=!0,a.shadow.mapSize.set(1024,1024),this.group.add(a)}_buildExtras(){const e=new ue(new Ji(2.8,1.6),this._stdMat({color:7031354,roughness:.95}));e.rotation.x=-Math.PI/2,e.position.set(0,.13,.35),e.receiveShadow=!0,e.castShadow=!1,this.group.add(e);const t=new ue(new It(.06,.08,.04,12),this._stdMat({color:3815994,roughness:.4,metalness:.4}));t.position.set(.85,.87,-.1),this._addMesh(t);const n=new ue(new It(.015,.015,.22,8),this._stdMat({color:2763306,roughness:.5,metalness:.3}));n.position.set(.85,.99,-.18),n.rotation.x=.5,this._addMesh(n);const i=new ue(new It(.1,.14,.12,12,1,!0),this._stdMat({color:16774365,emissive:16770232,emissiveIntensity:.55,roughness:.6,side:bn}));i.position.set(.85,1.08,-.28),i.rotation.x=.5,this._addMesh(i);const r=new ue(new It(.2,.2,.03,20),this._stdMat({color:16117984,roughness:.8}));r.position.set(0,3.2,-2.38),r.rotation.x=Math.PI/2,this._addMesh(r);const a=new ue(new Dc(.21,.02,8,24),this._stdMat({color:9137998,roughness:.75}));a.position.set(0,3.2,-2.36),a.rotation.y=Math.PI/2,this._addMesh(a)}}const ma=5,ps=4.5,gs=5;function En(s,e=.85){return new ts({color:s,roughness:e,metalness:0})}function Jy(s){const e=new xn,t=En(3814728),n=En(2762040),i=En(4867160),r=En(s,.7),a=new ue(new nt(ma,.12,gs),t);a.position.y=.06,a.receiveShadow=!0,e.add(a);const o=new ue(new nt(ma,.1,gs),n);o.position.y=ps-.05,o.receiveShadow=!0,e.add(o);const c=new ue(new nt(.12,ps,gs),i);c.position.set(-ma/2+.06,ps/2,0),c.castShadow=!0,c.receiveShadow=!0,e.add(c);const l=new ue(new nt(ma,ps,.12),r);return l.position.set(0,ps/2,-gs/2+.06),l.castShadow=!0,l.receiveShadow=!0,e.add(l),e}class Qy{constructor(){this.group=new xn,Dr.forEach((e,t)=>{const n=new xn;n.position.y=e.y;let i=1710116;if(t===1&&(i=13935776),t===2&&(i=13216110),t===3&&(i=6048376),t===4&&(i=15789027),n.add(Jy(i)),t===0){const r=new Xt,a=420,o=new Float32Array(a*3);for(let l=0;l<a;l++)o[l*3]=(Math.random()-.5)*4,o[l*3+1]=Math.random()*3.5+.2,o[l*3+2]=(Math.random()-.5)*3;r.setAttribute("position",new Rt(o,3));const c=new hd(r,new Lc({color:13216110,size:.04,transparent:!0,opacity:.85}));n.add(c)}if(t===1){const r=new Zy;n.add(r.group)}if(t===2){const r=new ue(new It(.55,.6,.08,24),En(7033668));r.position.set(0,.85,.2),r.castShadow=!0,n.add(r);const a=new ue(new It(.07,.08,.12,12),En(16777215));a.position.set(-.15,.98,.15),n.add(a);const o=new ue(new It(.07,.08,.12,12),En(16117992));o.position.set(.18,.98,.22),n.add(o);const c=new ue(new It(.05,.06,.2,10),En(16775400));c.position.set(.05,1.05,-.05),n.add(c);const l=new Uc(16764040,.8,8);l.position.set(0,1.4,.5),n.add(l)}if(t===3)for(let r=0;r<24;r++){const a=new ue(new mi(.08+Math.random()*.1,10,10),new ts({color:r%2?15245512:12099816,transparent:!0,opacity:.45,roughness:.3}));a.position.set((Math.random()-.5)*3,.5+Math.random()*3,(Math.random()-.5)*2.5),n.add(a)}if(t===4){const r=new ue(new nt(1.4,1,.04),En(16776696,.35));r.position.set(0,2.2,-gs/2+.2),r.castShadow=!0,n.add(r);const a=new ue(new It(.02,.03,.5,8),En(4881482));a.position.set(1.2,.55,.8),n.add(a);const o=new ue(new mi(.12,8,8),En(15907014,.4));o.position.set(1.2,.95,.8),n.add(o)}this.group.add(n)})}}class Eu{constructor(e){if(this.group=new xn,this.group.name="tower",Dr.length>0&&Dr.every(n=>{const i=e.items[`floor-${n.id}`];return i&&i.scene}))for(const n of Dr){const r=e.items[`floor-${n.id}`].scene.clone(!0);r.position.set(0,n.y,0),r.traverse(a=>{a.isMesh&&(a.castShadow=!0,a.receiveShadow=!0)}),this.group.add(r)}else{const n=new Qy;this.group.add(n.group)}}setY(e){this.group.position.y=e}}const eS=[],Cr=class Cr{constructor(e){if(Cr.instance)return Cr.instance;Cr.instance=this,this.canvas=e,this.scene=new Qx,this.clock=new Cv,this.sizes={width:1,height:1,pixelRatio:Math.min(window.devicePixelRatio,2)},this._updateSizes(),this.assetLoader=new EM(eS),this.camera=new bM,this.renderer=new AM,this.scroll=new Yy,this.floorTracker=new jy,this.htmlPanels=new Ky,this._setupLighting(),this.tower=new Eu(this.assetLoader),this.scene.add(this.tower.group),this.assetLoader.on("complete",()=>{Dr.every(r=>{const a=this.assetLoader.items[`floor-${r.id}`];return a&&a.scene})&&(this.scene.remove(this.tower.group),this.tower=new Eu(this.assetLoader),this.scene.add(this.tower.group));const i=document.getElementById("loader");i==null||i.classList.add("hidden")}),this.assetLoader.on("progress",(n,i)=>{const r=document.querySelector("#loader .loader-fill");if(!r)return;const a=i?n/i:1;r.style.width=`${Math.min(100,Math.max(0,a*100))}%`}),this.assetLoader.startLoading(),this.audioController=new $y,this.audioController.loadTrack("/audio/ambient.mp3");const t=Dr.length-1;this.htmlPanels.onNavClick=n=>{this.scroll.goTo(t>0?n/t:0)},window.addEventListener("resize",()=>this.onResize()),this.tick()}_updateSizes(){const e=document.getElementById("canvas-container");e&&(this.sizes.width=e.clientWidth||1,this.sizes.height=e.clientHeight||1,this.sizes.pixelRatio=Math.min(window.devicePixelRatio,2))}_setupLighting(){const e=new bv(12104904,.35);this.scene.add(e);const t=new rc(13157084,.45);t.position.set(-8,10,6),this.scene.add(t);const n=new rc(16774632,.95);n.position.set(12,18,10),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.camera.near=.5,n.shadow.camera.far=60,n.shadow.camera.left=-15,n.shadow.camera.right=15,n.shadow.camera.top=15,n.shadow.camera.bottom=-15,this.scene.add(n)}onResize(){this._updateSizes(),this.camera.onResize(),this.renderer.onResize()}tick(){window.requestAnimationFrame(()=>this.tick()),this.scroll.update(),this.tower.setY(this.scroll.getTowerY()),this.floorTracker.update(this.scroll.progress),this.htmlPanels.setActivePanel(this.floorTracker.activeFloorIndex);const e=document.querySelector("#scroll-progress .progress-fill");e&&(e.style.width=`${this.scroll.progress*100}%`),this.audioController.updateWithProgress(this.scroll.progress),this.renderer.render()}};cl(Cr,"instance",null);let Ns=Cr;const Mi=document.querySelector("#webgl");Mi==null||Mi.setAttribute("tabindex","0");const Es=new Ns(Mi);Mi==null||Mi.addEventListener("pointerdown",()=>Mi.focus(),{once:!0});const _a=document.getElementById("audio-toggle");_a&&_a.addEventListener("click",async()=>{await Es.audioController.toggle(),_a.classList.toggle("playing",Es.audioController.isPlaying),_a.setAttribute("aria-label",Es.audioController.isPlaying?"Pause music":"Play music")});const Xo=document.getElementById("arrow-prev"),qo=document.getElementById("arrow-next"),_f=s=>{const e=Es.floorTracker.activeFloorIndex??0,t=4,n=Math.min(t,Math.max(0,e+s));if(n===e)return;const i=n/t;Es.scroll.goTo(i)};Xo==null||Xo.addEventListener("click",()=>_f(-1));qo==null||qo.addEventListener("click",()=>_f(1));var bu;(bu=document.querySelector(".inv-rsvp-btn"))==null||bu.addEventListener("click",s=>{var n;s.preventDefault();const e=s.currentTarget,t=(n=e==null?void 0:e.dataset)==null?void 0:n.rsvpUrl;if(t){window.open(t,"_blank","noopener,noreferrer");return}window.location.href="mailto:hello@example.com?subject=Wedding%20RSVP%20%E2%80%94%20Owen%20%26%20Yilin"});
//# sourceMappingURL=index-BVus8OoR.js.map
