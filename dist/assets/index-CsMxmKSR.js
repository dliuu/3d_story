...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function gh(){return new wi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wc(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function xh(){return new wi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wc(),fragmentShader:`
...
`].filter(wr).join(`
`)),a=nc(a),a=wh(a,t),a=Rh(a,t),o=nc(o),o=wh(o,t),o=Rh(o,t),a=Ch(a),o=Ch(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
